...
EMSCRIPTEN_BINDINGS(libcellml_generatorcontext)
{
    class_<libcellml::GeneratorContext, base<libcellml::Logger>>("GeneratorContext")
        ...
        .function("trackedAlgebraicVariableCount", &libcellml::GeneratorContext::trackedAlgebraicVariableCount)
        .function("untrackedAlgebraicVariableCount", &libcellml::GeneratorContext::untrackedAlgebraicVariableCount)
