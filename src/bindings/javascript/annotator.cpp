...
EMSCRIPTEN_BINDINGS(libcellml_annotator)
{
    class_<libcellml::Annotator>("Annotator")
        ...
        .function("unitById", select_overload<libcellml::UnitsItemPtr(const std::string &, size_t)>(&libcellml::Annotator::unitsItem))
        .function("unitById", select_overload<libcellml::UnitsItemPtr(const std::string &)>(&libcellml::Annotator::unitsItem))
