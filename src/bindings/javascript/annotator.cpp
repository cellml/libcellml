...
EMSCRIPTEN_BINDINGS(libcellml_annotator)
{
    class_<libcellml::Annotator>("Annotator")
        ...
        .function("model", select_overload<libcellml::ModelPtr(const std::string &)>(&libcellml::Annotator::model))
        .function("modelByIndex", select_overload<libcellml::ModelPtr(const std::string &, size_t)>(&libcellml::Annotator::model))
