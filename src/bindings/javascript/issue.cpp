...
EMSCRIPTEN_BINDINGS(libcellml_issue) {
    ...
    enum_<libcellml::Issue::ReferenceRule>("Issue.ReferenceRule")
        ...
        .value("GENERATOR_NULL_MODEL", libcellml::Issue::ReferenceRule::GENERATOR_NULL_MODEL)
        .value("GENERATOR_NULL_VARIABLE", libcellml::Issue::ReferenceRule::GENERATOR_NULL_VARIABLE)
        .value("GENERATOR_VOI_VARIABLE_ALWAYS_TRACKED", libcellml::Issue::ReferenceRule::GENERATOR_VOI_VARIABLE_ALWAYS_TRACKED)
        .value("GENERATOR_VOI_VARIABLE_NOT_UNTRACKABLE", libcellml::Issue::ReferenceRule::GENERATOR_VOI_VARIABLE_NOT_UNTRACKABLE)
        .value("GENERATOR_STATE_VARIABLE_ALWAYS_TRACKED", libcellml::Issue::ReferenceRule::GENERATOR_STATE_VARIABLE_ALWAYS_TRACKED)
        .value("GENERATOR_STATE_VARIABLE_NOT_UNTRACKABLE", libcellml::Issue::ReferenceRule::GENERATOR_STATE_VARIABLE_NOT_UNTRACKABLE)
        .value("GENERATOR_EXTERNAL_VARIABLE_ALWAYS_TRACKED", libcellml::Issue::ReferenceRule::GENERATOR_EXTERNAL_VARIABLE_ALWAYS_TRACKED)
        .value("GENERATOR_EXTERNAL_VARIABLE_NOT_UNTRACKABLE", libcellml::Issue::ReferenceRule::GENERATOR_EXTERNAL_VARIABLE_NOT_UNTRACKABLE)
        .value("GENERATOR_NLA_BASED_VARIABLE_ALWAYS_TRACKED", libcellml::Issue::ReferenceRule::GENERATOR_NLA_BASED_VARIABLE_ALWAYS_TRACKED)
        .value("GENERATOR_NLA_BASED_VARIABLE_NOT_UNTRACKABLE", libcellml::Issue::ReferenceRule::GENERATOR_NLA_BASED_VARIABLE_NOT_UNTRACKABLE)
        .value("GENERATOR_EXTERNALLY_NEEDED_VARIABLE_ALWAYS_TRACKED", libcellml::Issue::ReferenceRule::GENERATOR_EXTERNALLY_NEEDED_VARIABLE_ALWAYS_TRACKED)
        .value("GENERATOR_EXTERNALLY_NEEDED_VARIABLE_NOT_UNTRACKABLE", libcellml::Issue::ReferenceRule::GENERATOR_EXTERNALLY_NEEDED_VARIABLE_NOT_UNTRACKABLE)
    ...
    class_<libcellml::Issue>("Issue")
        ...
        .class_function("levelAsString", &libcellml::Issue::levelAsString)
        .class_function("referenceRuleAsString", &libcellml::Issue::referenceRuleAsString)
    ;
