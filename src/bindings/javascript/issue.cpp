...
EMSCRIPTEN_BINDINGS(libcellml_issue) {
    ...
    class_<libcellml::Issue>("Issue")
        ...
        .function("setConnectionByVariablePair", select_overload<void(const libcellml::VariablePairPtr &)>(&libcellml::Issue::setConnection))
        .function("setConnectionByVariables", select_overload<void(const libcellml::VariablePtr &, const libcellml::VariablePtr &)>(&libcellml::Issue::setConnection))
        .function("connection", &libcellml::Issue::math)
        .function("setMapVariablesByVariablePair", select_overload<void(const libcellml::VariablePairPtr &)>(&libcellml::Issue::setMapVariables))
        .function("setMapVariablesByVariables", select_overload<void(const libcellml::VariablePtr &, const libcellml::VariablePtr &)>(&libcellml::Issue::setMapVariables))
        .function("mapVariables", &libcellml::Issue::math)
        ...
        .function("setUnit", &libcellml::Issue::setUnit)
        .function("unit", &libcellml::Issue::unit)
