...
EMSCRIPTEN_BINDINGS(libcellml_analyserequation)
{
    ...
    class_<libcellml::AnalyserEquation>("AnalyserEquation")
        ...
        .function("constantCount", &libcellml::AnalyserEquation::constantCount)
        .function("constants", select_overload<std::vector<libcellml::AnalyserVariablePtr>() const>(&libcellml::AnalyserEquation::constants))
        .function("constant", select_overload<libcellml::AnalyserVariablePtr(size_t) const>(&libcellml::AnalyserEquation::constant))
