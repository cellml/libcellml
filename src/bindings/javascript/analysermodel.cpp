...
EMSCRIPTEN_BINDINGS(libcellml_analysermodel)
{
    ...
    class_<libcellml::AnalyserModel>("AnalyserModel")
        ...
        .function("externalCount", &libcellml::AnalyserModel::externalCount)
        .function("externals", select_overload<std::vector<libcellml::AnalyserVariablePtr>() const>(&libcellml::AnalyserModel::externals))
        .function("external", select_overload<libcellml::AnalyserVariablePtr(size_t) const>(&libcellml::AnalyserModel::external))
