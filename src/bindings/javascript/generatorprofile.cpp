...
EMSCRIPTEN_BINDINGS(libcellml_generatorprofile)
{
    ...
    class_<libcellml::GeneratorProfile>("GeneratorProfile")
        ...
        .class_function("profileAsString", &libcellml::GeneratorProfile::profileAsString)
        ...
        .function("equalityString", &libcellml::GeneratorProfile::equalityString)
        .function("setEqualityString", &libcellml::GeneratorProfile::setEqualityString)
        ...
        .function("interfaceConstantCountString", &libcellml::GeneratorProfile::interfaceConstantCountString)
        .function("setInterfaceConstantCountString", &libcellml::GeneratorProfile::setInterfaceConstantCountString)
        .function("implementationConstantCountString", &libcellml::GeneratorProfile::implementationConstantCountString)
        .function("setImplementationConstantCountString", &libcellml::GeneratorProfile::setImplementationConstantCountString)
        .function("interfaceComputedConstantCountString", &libcellml::GeneratorProfile::interfaceComputedConstantCountString)
        .function("setInterfaceComputedConstantCountString", &libcellml::GeneratorProfile::setInterfaceComputedConstantCountString)
        .function("implementationComputedConstantCountString", &libcellml::GeneratorProfile::implementationComputedConstantCountString)
        .function("setImplementationComputedConstantCountString", &libcellml::GeneratorProfile::setImplementationComputedConstantCountString)
        .function("interfaceAlgebraicVariableCountString", &libcellml::GeneratorProfile::interfaceAlgebraicVariableCountString)
        .function("setInterfaceAlgebraicVariableCountString", &libcellml::GeneratorProfile::setInterfaceAlgebraicVariableCountString)
        .function("implementationAlgebraicVariableCountString", &libcellml::GeneratorProfile::implementationAlgebraicVariableCountString)
        .function("setImplementationAlgebraicVariableCountString", &libcellml::GeneratorProfile::setImplementationAlgebraicVariableCountString)
        .function("interfaceExternalVariableCountString", &libcellml::GeneratorProfile::interfaceExternalVariableCountString)
        .function("setInterfaceExternalVariableCountString", &libcellml::GeneratorProfile::setInterfaceExternalVariableCountString)
        .function("implementationExternalVariableCountString", &libcellml::GeneratorProfile::implementationExternalVariableCountString)
        .function("setImplementationExternalVariableCountString", &libcellml::GeneratorProfile::setImplementationExternalVariableCountString)
        ...
        .function("interfaceConstantInfoString", &libcellml::GeneratorProfile::interfaceConstantInfoString)
        .function("setInterfaceConstantInfoString", &libcellml::GeneratorProfile::setInterfaceConstantInfoString)
        .function("implementationConstantInfoString", &libcellml::GeneratorProfile::implementationConstantInfoString)
        .function("setImplementationConstantInfoString", &libcellml::GeneratorProfile::setImplementationConstantInfoString)
        .function("interfaceComputedConstantInfoString", &libcellml::GeneratorProfile::interfaceComputedConstantInfoString)
        .function("setInterfaceComputedConstantInfoString", &libcellml::GeneratorProfile::setInterfaceComputedConstantInfoString)
        .function("implementationComputedConstantInfoString", &libcellml::GeneratorProfile::implementationComputedConstantInfoString)
        .function("setImplementationComputedConstantInfoString", &libcellml::GeneratorProfile::setImplementationComputedConstantInfoString)
        .function("interfaceAlgebraicVariableInfoString", &libcellml::GeneratorProfile::interfaceAlgebraicVariableInfoString)
        .function("setInterfaceAlgebraicVariableInfoString", &libcellml::GeneratorProfile::setInterfaceAlgebraicVariableInfoString)
        .function("implementationAlgebraicVariableInfoString", &libcellml::GeneratorProfile::implementationAlgebraicVariableInfoString)
        .function("setImplementationAlgebraicVariableInfoString", &libcellml::GeneratorProfile::setImplementationAlgebraicVariableInfoString)
        .function("interfaceExternalVariableInfoString", &libcellml::GeneratorProfile::interfaceExternalVariableInfoString)
        .function("setInterfaceExternalVariableInfoString", &libcellml::GeneratorProfile::setInterfaceExternalVariableInfoString)
        .function("implementationExternalVariableInfoString", &libcellml::GeneratorProfile::implementationExternalVariableInfoString)
        .function("setImplementationExternalVariableInfoString", &libcellml::GeneratorProfile::setImplementationExternalVariableInfoString)
        ...
        .function("algebraicVariablesArrayString", &libcellml::GeneratorProfile::algebraicVariablesArrayString)
        .function("setAlgebraicVariablesArrayString", &libcellml::GeneratorProfile::setAlgebraicVariablesArrayString)
        .function("externalVariablesArrayString", &libcellml::GeneratorProfile::externalVariablesArrayString)
        .function("setExternalVariablesArrayString", &libcellml::GeneratorProfile::setExternalVariablesArrayString)
        ...
        .function("rootFindingInfoObjectString", &libcellml::GeneratorProfile::rootFindingInfoObjectString)
        .function("setRootFindingInfoObjectString", &libcellml::GeneratorProfile::setRootFindingInfoObjectString)
        .function("externNlaSolveMethodString", &libcellml::GeneratorProfile::externNlaSolveMethodString)
        .function("setExternNlaSolveMethodString", &libcellml::GeneratorProfile::setExternNlaSolveMethodString)
        .function("findRootCallString", &libcellml::GeneratorProfile::findRootCallString)
        .function("setFindRootCallString", &libcellml::GeneratorProfile::setFindRootCallString)
        .function("findRootMethodString", &libcellml::GeneratorProfile::findRootMethodString)
        .function("setFindRootMethodString", &libcellml::GeneratorProfile::setFindRootMethodString)
        .function("nlaSolveCallString", &libcellml::GeneratorProfile::nlaSolveCallString)
        .function("setNlaSolveCallString", &libcellml::GeneratorProfile::setNlaSolveCallString)
        .function("objectiveFunctionMethodString", &libcellml::GeneratorProfile::objectiveFunctionMethodString)
        .function("setObjectiveFunctionMethodString", &libcellml::GeneratorProfile::setObjectiveFunctionMethodString)
        .function("uArrayString", &libcellml::GeneratorProfile::uArrayString)
        .function("setUArrayString", &libcellml::GeneratorProfile::setUArrayString)
        .function("fArrayString", &libcellml::GeneratorProfile::fArrayString)
        .function("setFArrayString", &libcellml::GeneratorProfile::setFArrayString)
        ...
        .function("interfaceCreateConstantsArrayMethodString", &libcellml::GeneratorProfile::interfaceCreateConstantsArrayMethodString)
        .function("setInterfaceCreateConstantsArrayMethodString", &libcellml::GeneratorProfile::setInterfaceCreateConstantsArrayMethodString)
        .function("implementationCreateConstantsArrayMethodString", &libcellml::GeneratorProfile::implementationCreateConstantsArrayMethodString)
        .function("setImplementationCreateConstantsArrayMethodString", &libcellml::GeneratorProfile::setImplementationCreateConstantsArrayMethodString)
        .function("interfaceCreateComputedConstantsArrayMethodString", &libcellml::GeneratorProfile::interfaceCreateComputedConstantsArrayMethodString)
        .function("setInterfaceCreateComputedConstantsArrayMethodString", &libcellml::GeneratorProfile::setInterfaceCreateComputedConstantsArrayMethodString)
        .function("implementationCreateComputedConstantsArrayMethodString", &libcellml::GeneratorProfile::implementationCreateComputedConstantsArrayMethodString)
        .function("setImplementationCreateComputedConstantsArrayMethodString", &libcellml::GeneratorProfile::setImplementationCreateComputedConstantsArrayMethodString)
        .function("interfaceCreateAlgebraicVariablesArrayMethodString", &libcellml::GeneratorProfile::interfaceCreateAlgebraicVariablesArrayMethodString)
        .function("setInterfaceCreateAlgebraicVariablesArrayMethodString", &libcellml::GeneratorProfile::setInterfaceCreateAlgebraicVariablesArrayMethodString)
        .function("implementationCreateAlgebraicVariablesArrayMethodString", &libcellml::GeneratorProfile::implementationCreateAlgebraicVariablesArrayMethodString)
        .function("setImplementationCreateAlgebraicVariablesArrayMethodString", &libcellml::GeneratorProfile::setImplementationCreateAlgebraicVariablesArrayMethodString)
        .function("interfaceCreateExternalVariablesArrayMethodString", &libcellml::GeneratorProfile::interfaceCreateExternalVariablesArrayMethodString)
        .function("setInterfaceCreateExternalVariablesArrayMethodString", &libcellml::GeneratorProfile::setInterfaceCreateExternalVariablesArrayMethodString)
        .function("implementationCreateExternalVariablesArrayMethodString", &libcellml::GeneratorProfile::implementationCreateExternalVariablesArrayMethodString)
        .function("setImplementationCreateExternalVariablesArrayMethodString", &libcellml::GeneratorProfile::setImplementationCreateExternalVariablesArrayMethodString)
        ...
        .function("interfaceInitialiseArraysMethodString", &libcellml::GeneratorProfile::interfaceInitialiseArraysMethodString)
        .function("setInterfaceInitialiseArraysMethodString", &libcellml::GeneratorProfile::setInterfaceInitialiseArraysMethodString)
        .function("implementationInitialiseArraysMethodString", &libcellml::GeneratorProfile::implementationInitialiseArraysMethodString)
        .function("setImplementationInitialiseArraysMethodString", &libcellml::GeneratorProfile::setImplementationInitialiseArraysMethodString)
        ...
        .function("variableDeclarationString", &libcellml::GeneratorProfile::variableDeclarationString)
        .function("setVariableDeclarationString", &libcellml::GeneratorProfile::setVariableDeclarationString)
