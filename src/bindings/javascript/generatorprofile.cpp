...
EMSCRIPTEN_BINDINGS(libcellml_generatorprofile)
{
    ...
    class_<libcellml::GeneratorProfile>("GeneratorProfile")
        ...
        .function("variableTypeObjectInAlgebraicModelString", &libcellml::GeneratorProfile::variableTypeObjectInAlgebraicModelString)
        .function("setVariableTypeObjectInAlgebraicModelString", &libcellml::GeneratorProfile::setVariableTypeObjectInAlgebraicModelString)
        .function("variableTypeObjectExternalTypeInAlgebraicModelString", &libcellml::GeneratorProfile::variableTypeObjectExternalTypeInAlgebraicModelString)
        .function("setVariableTypeObjectExternalTypeInAlgebraicModelString", &libcellml::GeneratorProfile::setVariableTypeObjectExternalTypeInAlgebraicModelString)
        .function("variableTypeObjectInDifferentialModelString", &libcellml::GeneratorProfile::variableTypeObjectInDifferentialModelString)
        .function("setVariableTypeObjectInDifferentialModelString", &libcellml::GeneratorProfile::setVariableTypeObjectInDifferentialModelString)
        .function("variableTypeObjectExternalTypeInDifferentialModelString", &libcellml::GeneratorProfile::variableTypeObjectExternalTypeInDifferentialModelString)
        .function("setVariableTypeObjectExternalTypeInDifferentialModelString", &libcellml::GeneratorProfile::setVariableTypeObjectExternalTypeInDifferentialModelString)
        ...
        .function("externalVariableMethodTypeDefinitionInAlgebraicModelString", &libcellml::GeneratorProfile::externalVariableMethodTypeDefinitionInAlgebraicModelString)
        .function("setExternalVariableMethodTypeDefinitionInAlgebraicModelString", &libcellml::GeneratorProfile::setExternalVariableMethodTypeDefinitionInAlgebraicModelString)
        .function("externalVariableMethodTypeDefinitionInDifferentialModelString", &libcellml::GeneratorProfile::externalVariableMethodTypeDefinitionInDifferentialModelString)
        .function("setExternalVariableMethodTypeDefinitionInDifferentialModelString", &libcellml::GeneratorProfile::setExternalVariableMethodTypeDefinitionInDifferentialModelString)
        ...
        .function("externalVariableMethodCallInAlgebraicModelString", &libcellml::GeneratorProfile::externalVariableMethodCallInAlgebraicModelString)
        .function("setExternalVariableMethodCallInAlgebraicModelString", &libcellml::GeneratorProfile::setExternalVariableMethodCallInAlgebraicModelString)
        .function("externalVariableMethodCallInDifferentialModelString", &libcellml::GeneratorProfile::externalVariableMethodCallInDifferentialModelString)
        .function("setExternalVariableMethodCallInDifferentialModelString", &libcellml::GeneratorProfile::setExternalVariableMethodCallInDifferentialModelString)
        ...
        .function("interfaceComputeVariablesMethodInAlgebraicModelString", &libcellml::GeneratorProfile::interfaceComputeVariablesMethodInAlgebraicModelString)
        .function("setInterfaceComputeVariablesMethodInAlgebraicModelString", &libcellml::GeneratorProfile::setInterfaceComputeVariablesMethodInAlgebraicModelString)
        .function("implementationComputeVariablesMethodInAlgebraicModelString", &libcellml::GeneratorProfile::implementationComputeVariablesMethodInAlgebraicModelString)
        .function("setImplementationComputeVariablesMethodInAlgebraicModelString", &libcellml::GeneratorProfile::setImplementationComputeVariablesMethodInAlgebraicModelString)
        .function("interfaceComputeVariablesMethodInDifferentialModelString", &libcellml::GeneratorProfile::interfaceComputeVariablesMethodInDifferentialModelString)
        .function("setInterfaceComputeVariablesMethodInDifferentialModelString", &libcellml::GeneratorProfile::setInterfaceComputeVariablesMethodInDifferentialModelString)
        .function("implementationComputeVariablesMethodInDifferentialModelString", &libcellml::GeneratorProfile::implementationComputeVariablesMethodInDifferentialModelString)
        .function("setImplementationComputeVariablesMethodInDifferentialModelString", &libcellml::GeneratorProfile::setImplementationComputeVariablesMethodInDifferentialModelString)
