...
SWIGINTERN PyObject *_wrap_version(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  result = (unsigned int)libcellml::version();
...
SWIGINTERN PyObject *_wrap_versionString(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::string result;
  
  if (!SWIG_Python_UnpackTuple(args, "versionString", 0, 0, 0)) SWIG_fail;
  result = libcellml::versionString();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "version", _wrap_version, METH_NOARGS, "Returns the version of the library as a number."},
	 { "versionString", _wrap_versionString, METH_NOARGS, "\n"
