        ...
        for (size_t j = 0; j < variable->equivalentVariableCount(); ++j) {
            ...
            if (equivalentVariable->hasEquivalentVariable(variable)) {
                ...
                auto pairFound = std::find_if(variableMap.begin(), variableMap.end(),
                                              [variable, equivalentVariable](const VariablePairPtr &in) { return (in->variable1() == equivalentVariable && in->variable2() == variable) || (in->variable1() == variable && in->variable2() == equivalentVariable); });
