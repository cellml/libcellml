...
public:
     ...
     *  - <CellMLElement::UNIT, @ref Unit> - Retrieve id with Units::unitId(size_t) const.
     ...
     * @return the new id string.
     */
    std::string assignId(const VariablePairPtr &pair, CellMLElement type = CellMLElement::MAP_VARIABLES);
