...
public:
    ...
    enum class ReferenceRule
    {
        ...
        XML_UNEXPECTED_NAMESPACE_PREFIX,
        XML_ID_ATTRIBUTE,
        MODEL_ELEMENT,
        MODEL_NAME,
        MODEL_NAME_VALUE,
        ...
        IMPORT_UNITS_UNITS_REF,
        IMPORT_UNITS_UNITS_REF_VALUE,
        IMPORT_UNITS_UNITS_REF_VALUE_TARGET,
