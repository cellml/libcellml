...
/**
 * @brief Convert the @p from @c std::string to the @p to @c double.
 *
 * Convert the @p from @c std::string to a @c double. If @p from can be
 * converted using @c std::stod, return @c true and update @p to, otherwise
 * return @c false. To avoid returning @c false, @p from must be known to be
 * convertible to a @c double before calling this function.
 *
 * @sa isCellMLReal
 *
 * @param from The @c std::string value to convert to a @c double.
 * @param to The @c double value resulting from the conversion.
 *
 * @return @c true if @from represents a @c double, @c false otherwise.
 */
bool convertToDouble(const std::string &from, double &to);

/**
 * @brief Convert the @p from @c std::string to the @p to @c int.
 *
 * Convert the @p from @c std::string to an @c int. If @p from can be converted
 * using @c std::stoi, return @c true and update @p to, otherwise return
 * @c false. To avoid returning @c false, @p from must be known to be
 * convertible to an @c int before calling this function.
 *
 * @sa isCellMLInteger
 *
 * @param from The @c std::string value to convert to an @c int.
 * @param to The @c int value resulting from the conversion.
 *
 * @return @c true if @from represents an @c int, @c false otherwise.
 */
