...
/**
 * @brief Check if the provided @p name is a dimensionless unit.
 *
 * Checks if the provided @p name is the dimensionless unit. Returns @c true if
 * @p name is a dimensionless unit and @c false otherwise.
 *
 * @param name The @c std::string name to check against.
 *
 * @return @c true if @name is a dimensionless unit and @c false otherwise.
 */
