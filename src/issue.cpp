...
static const std::map<Issue::ReferenceRule, const std::string> ruleToHeading = {
    ...
    {Issue::ReferenceRule::DATA_REPR_IDENTIFIER_UNICODE, "1.3.1.1"},
    {Issue::ReferenceRule::DATA_REPR_IDENTIFIER_LATIN_ALPHANUM, "1.3.1.1"},
    {Issue::ReferenceRule::DATA_REPR_IDENTIFIER_AT_LEAST_ONE_ALPHANUM, "1.3.1.1"},
    {Issue::ReferenceRule::DATA_REPR_IDENTIFIER_BEGIN_EURO_NUM, "1.3.1.1"},
    {Issue::ReferenceRule::DATA_REPR_IDENTIFIER_IDENTICAL, "1.3.1.2"},
    {Issue::ReferenceRule::DATA_REPR_INT_BASE10, "1.3.2.1"},
    {Issue::ReferenceRule::DATA_REPR_INT_SIGN, "1.3.2.2"},
    {Issue::ReferenceRule::DATA_REPR_INT_DIGIT, "1.3.2.3"},
    {Issue::ReferenceRule::DATA_REPR_BASIC_REAL_BASE10, "1.3.3.1"},
    {Issue::ReferenceRule::DATA_REPR_BASIC_REAL_SIGN, "1.3.3.2"},
    {Issue::ReferenceRule::DATA_REPR_BASIC_REAL_DECIMAL, "1.3.3.3"},
    {Issue::ReferenceRule::DATA_REPR_BASIC_REAL_DIGIT, "1.3.3.4"},
    {Issue::ReferenceRule::DATA_REPR_REAL_BASE10, "1.3.4.1"},
    {Issue::ReferenceRule::DATA_REPR_REAL_SIGNIFICAND, "1.3.4.3"},
    {Issue::ReferenceRule::DATA_REPR_REAL_EXPONENT, "1.3.4.4"},
    {Issue::ReferenceRule::MODEL_ELEMENT, "2.1"},
    {Issue::ReferenceRule::MODEL_NAME, "2.1.1"},
    {Issue::ReferenceRule::MODEL_CHILD, "2.1.2"},
    {Issue::ReferenceRule::MODEL_MORE_THAN_ONE_ENCAPSULATION, "2.1.3"},
    {Issue::ReferenceRule::IMPORT_HREF, "2.2.1"},
    {Issue::ReferenceRule::IMPORT_CHILD, "2.2.2"},
    {Issue::ReferenceRule::IMPORT_EQUIVALENT, "2.2.3"},
    {Issue::ReferenceRule::IMPORT_UNITS_NAME, "2.3.1"},
    {Issue::ReferenceRule::IMPORT_UNITS_NAME_UNIQUE, "2.3.1"},
    {Issue::ReferenceRule::IMPORT_UNITS_REF, "2.3.2"},
    {Issue::ReferenceRule::IMPORT_COMPONENT_NAME, "2.4.1"},
    {Issue::ReferenceRule::IMPORT_COMPONENT_NAME_UNIQUE, "2.4.1"},
    {Issue::ReferenceRule::IMPORT_COMPONENT_COMPONENT_REF, "2.4.2"},
    {Issue::ReferenceRule::UNITS_NAME, "2.5.1"},
    {Issue::ReferenceRule::UNITS_NAME_UNIQUE, "2.5.1"},
    {Issue::ReferenceRule::UNITS_STANDARD, "2.5.2"},
    {Issue::ReferenceRule::UNITS_CHILD, "2.5.3"},
    {Issue::ReferenceRule::UNIT_UNITS_REF, "2.6.1"},
    {Issue::ReferenceRule::UNIT_CIRCULAR_REF, "2.6.1.2"},
    {Issue::ReferenceRule::UNIT_OPTIONAL_ATTRIBUTE, "2.6.2"},
    {Issue::ReferenceRule::UNIT_PREFIX, "2.6.2.1"},
    {Issue::ReferenceRule::UNIT_MULTIPLIER, "2.6.2.2"},
    {Issue::ReferenceRule::UNIT_EXPONENT, "2.6.2.3"},
    {Issue::ReferenceRule::COMPONENT_NAME, "2.7.1"},
    {Issue::ReferenceRule::COMPONENT_NAME_UNIQUE, "2.7.1"},
    {Issue::ReferenceRule::COMPONENT_CHILD, "2.7.2"},
    {Issue::ReferenceRule::VARIABLE_NAME, "2.8.1.1"},
    {Issue::ReferenceRule::VARIABLE_NAME_UNIQUE, "2.8.1.1"},
    {Issue::ReferenceRule::VARIABLE_UNITS, "2.8.1.2"},
    {Issue::ReferenceRule::VARIABLE_INTERFACE, "2.8.2.1"},
    {Issue::ReferenceRule::VARIABLE_INITIAL_VALUE, "2.8.2.2"},
    {Issue::ReferenceRule::RESET_VARIABLE_REF, "2.9.1.1"},
    {Issue::ReferenceRule::RESET_TEST_VARIABLE_REF, "2.9.1.2"},
    {Issue::ReferenceRule::RESET_ORDER, "2.9.1.3"},
    {Issue::ReferenceRule::RESET_CHILD, "2.9.2"},
    {Issue::ReferenceRule::RESET_TEST_VALUE, "2.10"},
    {Issue::ReferenceRule::RESET_RESET_VALUE, "2.11"},
    {Issue::ReferenceRule::MATH_MATHML, "2.12.1"},
    {Issue::ReferenceRule::MATH_CHILD, "2.12.2"},
    {Issue::ReferenceRule::MATH_CI_VARIABLE_REF, "2.12.3"},
    {Issue::ReferenceRule::MATH_CN_UNITS, "2.13.4"},
    {Issue::ReferenceRule::MATH_CN_BASE10, "2.13.5"},
    {Issue::ReferenceRule::MATH_CN_FORMAT, "2.13.5"},
    {Issue::ReferenceRule::ENCAPSULATION_CHILD, "2.13.1"},
    {Issue::ReferenceRule::COMPONENT_REF_COMPONENT, "2.14.1"},
    {Issue::ReferenceRule::COMPONENT_REF_CHILD, "2.14.2"},
    {Issue::ReferenceRule::CONNECTION_COMPONENT1, "2.15.1"},
    {Issue::ReferenceRule::CONNECTION_COMPONENT2, "2.15.2"},
    {Issue::ReferenceRule::CONNECTION_EXCLUDE_SELF, "2.15.3"},
    {Issue::ReferenceRule::CONNECTION_UNIQUE, "2.15.4"},
    {Issue::ReferenceRule::CONNECTION_CHILD, "2.15.5"},
    {Issue::ReferenceRule::MAP_VARIABLES_VARIABLE1, "2.16.1"},
    {Issue::ReferenceRule::MAP_VARIABLES_VARIABLE2, "2.16.2"},
    {Issue::ReferenceRule::MAP_VARIABLES_UNIQUE, "2.16.3"}};
