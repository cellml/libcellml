...
{
    // Collect all existing identifiers in a multiset and return. Duplicated identifiers are preserved so that
    // invalid models with repeated IDs can still be inspected or printed.
