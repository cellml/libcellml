...
{
    AnyCellmlElementPtr retrieved = AnyCellmlElement::AnyCellmlElementImpl::create();
...
{
    return mPimpl->canReturnItem(id, index) ? std::move(items(id)[index]) : AnyCellmlElement::AnyCellmlElementImpl::create();
}
