...
.. glossary::
   ...
   CMake
      `CMake <http://cmake.org/>`__ is an open-source, cross-platform family of tools designed to build, test and package software.  Instructions for installation of CMake can be found on the :ref:`Setup page <devsetup_cmake>`.
