...
extlinks = {
    ...
    'cmlibs_libxml2_repo': ('https://github.com/CMLibs-Dependencies/libxml2/releases%s', None),
    'cmlibs_zlib_repo': ('https://github.com/CMLibs-Dependencies/zlib/releases%s', None),
...
project = u'libCellML'
copyright = u'2014-@SPHINX_YEAR@, libCellML Contributors'
