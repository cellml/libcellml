...
==============================
Building libCellML from Source
==============================
...
It is best to build libCellML outside of the source tree.  To this end create a build directory that is not the LIBCELLML_SRC directory.  A sibling directory of LIBCELLML_SRC is a good choice, named something like::
