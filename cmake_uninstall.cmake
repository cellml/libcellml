macro(remove_empty_directory directory)
  ...
  if(NOT directoryFiles)
    exec_program("/usr/local/Cellar/cmake/3.14.4/bin/cmake" ARGS "-E remove_directory \"${directory}\""
...
if(NOT EXISTS "/Users/kmoy001/libCellML/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: /Users/kmoy001/libCellML/install_manifest.txt")
endif()

file(READ "/Users/kmoy001/libCellML/install_manifest.txt" fileNames)
...
foreach(fileName ${fileNames})
  ...
  if(IS_SYMLINK "${fullFileName}" OR EXISTS "${fullFileName}")
    exec_program("/usr/local/Cellar/cmake/3.14.4/bin/cmake" ARGS "-E remove \"${fullFileName}\""
                 OUTPUT_VARIABLE rmOut
                 RETURN_VALUE rmRetval)
