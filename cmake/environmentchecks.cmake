...
if(Python_Interpreter_FOUND)
  if(NOT DEFINED PYTHON_COVERAGE_TEST_PERFORMED OR NOT PYTHON_COVERAGE_FOUND)
    if(NOT DEFINED PYTHON_COVERAGE_TEST_PERFORMED)
    ...
    if(TEST_COVERAGE_RESULT EQUAL 0)
      ...
      set(_RESULT_TEXT Success)
    else()
      set(HAVE_COVERAGE FALSE)
      set(_RESULT_TEXT Failed)
    endif()
    if(PYTHON_COVERAGE_TEST_PERFORMED AND NOT PYTHON_COVERAGE_FOUND AND HAVE_COVERAGE)
      set(_PRINT_SUMMARY_MESSAGE TRUE)
      message(STATUS "Performing Test HAVE_COVERAGE")
    endif()
    if(NOT DEFINED PYTHON_COVERAGE_TEST_PERFORMED OR _PRINT_SUMMARY_MESSAGE)
      message(STATUS "Performing Test HAVE_COVERAGE - ${_RESULT_TEXT}")
    endif()
    set(PYTHON_COVERAGE_FOUND ${HAVE_COVERAGE} CACHE INTERNAL "Python coverage was found." FORCE)
    set(PYTHON_COVERAGE_TEST_PERFORMED TRUE CACHE INTERNAL "Testing for Python coverage has occured.")
  endif()
endif()
