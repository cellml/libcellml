...
if(LibXml2_FOUND)
  ...
  execute_process(COMMAND ls "${LibXml2_DIR}" OUTPUT_VARIABLE LIBXML2_DIR_CONTENTS)
  message(STATUS "LibXml2_DIR contents:")
  message(STATUS "${LIBXML2_DIR_CONTENTS}")
  file(READ "${LibXml2_DIR}/libxml2-config.cmake" LIBXML2_CONFIG_CONTENTS)
  message(STATUS "libxml2-config.cmake contents:")
  message(STATUS "${LIBXML2_CONFIG_CONTENTS}")
  if(TARGET xml2)
