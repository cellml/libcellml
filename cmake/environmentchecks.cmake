...
if(CLANG_FORMAT_EXE AND GIT_EXE)
  set(CLANG_FORMAT_VERSION_NEEDED 11)
  ...
  if(CLANG_FORMAT_VERSION VERSION_LESS CLANG_FORMAT_VERSION_NEEDED)
    message(STATUS "ClangFormat ${CLANG_FORMAT_VERSION} was found, but version ${CLANG_FORMAT_VERSION_NEEDED}+ is needed to run the ClangFormat test")
  else()
