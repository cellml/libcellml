...
function(get_runtime_dlls_from_target target out_dlls_var out_names_var)
  set(_result "")
  set(_result_names "")
  ...
  foreach(item IN LISTS _items)
    if(TARGET ${item})
      ...
      if(_type STREQUAL "SHARED_LIBRARY" OR _type STREQUAL "MODULE_LIBRARY")
        list(APPEND _result $<TARGET_FILE:${item}>)
        list(APPEND _result_names $<TARGET_FILE_NAME:${item}>)
      endif()
    endif()
  endforeach()
  set(${out_dlls_var} "${_result}" PARENT_SCOPE)
  set(${out_names_var} "${_result_names}" PARENT_SCOPE)
endfunction()
