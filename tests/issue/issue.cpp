...
TEST(Issue, createModelIssue)
{
    ...
    EXPECT_EQ(libcellml::CellMLElement::MODEL, e->cellmlElementType());
}
...
TEST(Issue, createComponentIssue)
{
    ...
    EXPECT_EQ(libcellml::CellMLElement::COMPONENT, e->cellmlElementType());
}
...
TEST(Issue, createVariableIssue)
{
    ...
    EXPECT_EQ(libcellml::CellMLElement::VARIABLE, e->cellmlElementType());
}
...
TEST(Issue, createUnitsIssue)
{
    ...
    EXPECT_EQ(libcellml::CellMLElement::UNITS, e->cellmlElementType());
}
...
TEST(Issue, createImportSourceIssue)
{
    ...
    EXPECT_EQ(libcellml::CellMLElement::IMPORT, e->cellmlElementType());
}
...
TEST(Issue, createResetIssue)
{
    ...
    EXPECT_EQ(libcellml::CellMLElement::RESET, e->cellmlElementType());
}
...
TEST(Issue, createUnitWarning)
{
    ...
    e->setLevel(libcellml::Issue::Level::WARNING);
    EXPECT_EQ(libcellml::CellMLElement::UNIT, e->cellmlElementType());
    EXPECT_EQ(libcellml::Issue::Level::WARNING, e->level());
}
...
TEST(Issue, setGetItems)
{
    ...
    issue->setComponent(component);
    EXPECT_EQ(component, issue->component());
    EXPECT_EQ(libcellml::CellMLElement::COMPONENT, issue->cellmlElementType());
    ...
    EXPECT_EQ(libcellml::CellMLElement::COMPONENT_REF, issue->cellmlElementType());
    EXPECT_EQ(component, std::any_cast<libcellml::ComponentPtr>(issue->item()));
    ...
    EXPECT_EQ(libcellml::CellMLElement::CONNECTION, issue->cellmlElementType());
    ...
    EXPECT_EQ(libcellml::CellMLElement::ENCAPSULATION, issue->cellmlElementType());
    ...
    EXPECT_EQ(libcellml::CellMLElement::IMPORT, issue->cellmlElementType());
    ...
    EXPECT_EQ(libcellml::CellMLElement::MAP_VARIABLES, issue->cellmlElementType());
    EXPECT_EQ(variable1, std::any_cast<libcellml::VariablePairPtr>(issue->item())->variable1());
    EXPECT_EQ(variable2, std::any_cast<libcellml::VariablePairPtr>(issue->item())->variable2());

    issue->setMath(component);
    EXPECT_EQ(component, issue->math());
    EXPECT_EQ(libcellml::CellMLElement::MATH, issue->cellmlElementType());
    EXPECT_EQ(component, std::any_cast<libcellml::ComponentPtr>(issue->item()));

    issue->setModel(model);
    EXPECT_EQ(model, issue->model());
    EXPECT_EQ(libcellml::CellMLElement::MODEL, issue->cellmlElementType());
    EXPECT_EQ(model, std::any_cast<libcellml::ModelPtr>(issue->item()));

    issue->setReset(reset);
    EXPECT_EQ(reset, issue->reset());
    EXPECT_EQ(libcellml::CellMLElement::RESET, issue->cellmlElementType());
    EXPECT_EQ(reset, std::any_cast<libcellml::ResetPtr>(issue->item()));

    issue->setResetValue(reset);
    EXPECT_EQ(reset, issue->resetValue());
    EXPECT_EQ(libcellml::CellMLElement::RESET_VALUE, issue->cellmlElementType());
    EXPECT_EQ(reset, std::any_cast<libcellml::ResetPtr>(issue->item()));

    issue->setTestValue(reset);
    EXPECT_EQ(reset, issue->testValue());
    EXPECT_EQ(libcellml::CellMLElement::TEST_VALUE, issue->cellmlElementType());
    EXPECT_EQ(reset, std::any_cast<libcellml::ResetPtr>(issue->item()));

    issue->setUnit(libcellml::Unit::create(units, 0));
    EXPECT_EQ(units, issue->unit()->units());
    EXPECT_EQ(size_t(0), issue->unit()->index());
    EXPECT_EQ(libcellml::CellMLElement::UNIT, issue->cellmlElementType());
    ...
    EXPECT_EQ(libcellml::CellMLElement::UNITS, issue->cellmlElementType());
    EXPECT_EQ(units, std::any_cast<libcellml::UnitsPtr>(issue->item()));

    issue->setVariable(variable1);
    EXPECT_EQ(variable1, issue->variable());
    EXPECT_EQ(libcellml::CellMLElement::VARIABLE, issue->cellmlElementType());
...
TEST(Issue, createCorrectType)
{
    ...
    EXPECT_NE(nullptr, libcellml::Issue::create(component, libcellml::CellMLElement::MATH));
...
TEST(Issue, createMismatchedTypeReturnsNull)
{
    ...
    EXPECT_EQ(nullptr, libcellml::Issue::create(model, libcellml::CellMLElement::MATH));
    EXPECT_EQ(nullptr, libcellml::Issue::create(reset, libcellml::CellMLElement::IMPORT));
    EXPECT_EQ(nullptr, libcellml::Issue::create(libcellml::VariablePair::create(variable1, variable2), libcellml::CellMLElement::VARIABLE));
}
...
TEST(Issue, setItemWithNullptr)
{
    ...
    issue->setItem(libcellml::CellMLElement::UNIT, unit);
    EXPECT_EQ(libcellml::CellMLElement::UNIT, issue->cellmlElementType());
...
TEST(Issue, clearStoredItem)
{
    ...
    issue->setModel(nullptr);
    EXPECT_EQ(nullptr, issue->model());
    EXPECT_EQ(libcellml::CellMLElement::UNDEFINED, issue->cellmlElementType());
...
TEST(Issue, setItemMisMatchingType)
{
    ...
    issue->setItem(libcellml::CellMLElement::MATH, model);
