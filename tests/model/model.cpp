...
TEST(Model, componentIndex)
{
    ...
    EXPECT_EQ(libcellml::MAX_SIZE_T, m->componentIndex(c3));
}
...
TEST(Model, unitsIndex)
{
    ...
    EXPECT_EQ(libcellml::MAX_SIZE_T, m->unitsIndex(u3));
}
...
TEST(Model, importSourceIndex)
{
    ...
    EXPECT_EQ(libcellml::MAX_SIZE_T, m->importSourceIndex(is3));
}
