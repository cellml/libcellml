...
class ErrorTestCase(unittest.TestCase):
    ...
    def test_specification_rule_enum(self):
        ...
        self.assertIsInstance(SpecificationRule.DATA_REPR_IDENTIFIER_ATLEAST1_ALPHANUM, int)
        ...
        self.assertIsInstance(SpecificationRule.MODEL_MORE_THAN_1_ENCAPSULATION, int)
