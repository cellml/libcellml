...
TEST(Validator, validateInvalidConnections) {
	...
	/// @cellml2_19 19.10.5 __TODO__ Validate TEST variable equivalence network must not contain any cycles
    ...
    // Valid connections.
    libcellml::Variable::addEquivalence(v1_1, v2);  // !! creates cycle with v1_1, v2, v3
    ...
    libcellml::Variable::addEquivalence(v2, v3);    // !! creates cycle with v1_1, v2, v3
	libcellml::Variable::addEquivalence(v5, v6);	// valid here but duplicated below

	// Not valid connections
	libcellml::Variable::addEquivalence(v1_1, v3);  // duplicated above, does not overwrite, skips silently
...
TEST(Validator, resets) {
	...
	/// @cellml2_12 12.1.1 __TODO__ Validate that reset variable exists in component.  Code to check commented out here
	/*r8->setOrder(20);
	r8->addWhen(w3);
