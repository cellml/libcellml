...
TEST(Validator, invalidMathMLElementsChildrenOrSiblings)
{
    const std::vector<std::string> expectedIssues = {
        ...
        "Math has a 'not' element without a MathML sibling.",
        ...
        "Math has a 'abs' element without a MathML sibling.",
        "Math has a 'abs' element which is not the first MathML sibling.",
        "Math has a 'exp' element without a MathML sibling.",
        "Math has a 'exp' element which is not the first MathML sibling.",
        "Math has a 'ln' element without a MathML sibling.",
        ...
        "Math has a 'ceiling' element without a MathML sibling.",
        "Math has a 'ceiling' element which is not the first MathML sibling.",
        "Math has a 'floor' element without a MathML sibling.",
