...
TEST(Generator, cellmlUnitScaling)
{
    libcellml::ParserPtr parser = libcellml::Parser::create();
    libcellml::ModelPtr model = parser->parseModel(fileContents("generator/cellml_unit_scaling/model.cellml"));
    ...
    EXPECT_EQ(size_t(7), generator->variableCount());
    ...
    EXPECT_EQ(fileContents("generator/cellml_unit_scaling/model.h"), generator->interfaceCode());
    EXPECT_EQ(fileContents("generator/cellml_unit_scaling/model.c"), generator->implementationCode());
