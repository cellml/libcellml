...
TEST(Generator, ode_computed_var_on_rhs)
{
    ...
    EXPECT_EQ(fileContents("generator/resources/ode_computed_var_on_rhs/initializeVariables.out"),
              generator.initializeVariables());
    EXPECT_EQ(EMPTY_STRING, generator.computeConstantEquations());
    EXPECT_EQ(fileContents("generator/resources/ode_computed_var_on_rhs/computeRateEquations.out"),
              generator.computeRateEquations());
    EXPECT_EQ(EMPTY_STRING, generator.computeAlgebraicEquations());
}
...
TEST(Generator, ode_computed_var_on_rhs_one_component)
{
    ...
    EXPECT_EQ(fileContents("generator/resources/ode_computed_var_on_rhs_one_component/initializeVariables.out"),
              generator.initializeVariables());
    EXPECT_EQ(EMPTY_STRING, generator.computeConstantEquations());
    EXPECT_EQ(fileContents("generator/resources/ode_computed_var_on_rhs_one_component/computeRateEquations.out"),
              generator.computeRateEquations());
    EXPECT_EQ(EMPTY_STRING, generator.computeAlgebraicEquations());
}
...
TEST(Generator, ode_const_var_on_rhs)
{
    ...
    EXPECT_EQ(fileContents("generator/resources/ode_const_var_on_rhs/initializeVariables.out"),
              generator.initializeVariables());
    EXPECT_EQ(EMPTY_STRING, generator.computeConstantEquations());
    EXPECT_EQ(fileContents("generator/resources/ode_const_var_on_rhs/computeRateEquations.out"),
              generator.computeRateEquations());
    EXPECT_EQ(EMPTY_STRING, generator.computeAlgebraicEquations());
}
...
TEST(Generator, ode_const_var_on_rhs_one_component)
{
    ...
    EXPECT_EQ(fileContents("generator/resources/ode_const_var_on_rhs_one_component/initializeVariables.out"),
              generator.initializeVariables());
    EXPECT_EQ(EMPTY_STRING, generator.computeConstantEquations());
    EXPECT_EQ(fileContents("generator/resources/ode_const_var_on_rhs_one_component/computeRateEquations.out"),
              generator.computeRateEquations());
    EXPECT_EQ(EMPTY_STRING, generator.computeAlgebraicEquations());
}
...
TEST(Generator, ode_constant_on_rhs)
{
    ...
    EXPECT_EQ(fileContents("generator/resources/ode_constant_on_rhs/initializeVariables.out"),
              generator.initializeVariables());
    EXPECT_EQ(EMPTY_STRING, generator.computeConstantEquations());
    EXPECT_EQ(fileContents("generator/resources/ode_constant_on_rhs/computeRateEquations.out"),
              generator.computeRateEquations());
    EXPECT_EQ(EMPTY_STRING, generator.computeAlgebraicEquations());
}
