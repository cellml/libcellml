...
const std::vector<std::string> daeIssues = {
    ...
    "Variable 'g_L' in component 'leakage_current' is computed using an NLA system and cannot therefore be untracked.",
    "Variable 'g_Na' in component 'sodium_channel' is computed using an NLA system and cannot therefore be untracked.",
    ...
    "Variable 'g_K' in component 'potassium_channel' is computed using an NLA system and cannot therefore be untracked.",
