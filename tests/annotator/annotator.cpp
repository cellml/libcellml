...
TEST(Annotator, automaticIdsOnEverything)
{
    ...
    EXPECT_EQ("b4da67", model->component("component2")->component(0)->id());
    EXPECT_EQ("b4da68", model->component("component3")->encapsulationId());
    EXPECT_EQ("b4da69", model->component("component2")->variable(0)->id());
    EXPECT_EQ("b4da6a", model->component("component2")->variable(1)->id());
    ...
    EXPECT_EQ("b4da66", libcellml::Variable::equivalenceConnectionId(c2v1, c3v1));
    EXPECT_EQ("b4da5f", libcellml::Variable::equivalenceConnectionId(c2v1, c4v1));
