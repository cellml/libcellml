...
void initialiseVariables(double *states, double *rates, double *constants, double *computedConstants, double *algebraic)
{
    ...
    computedConstants[206] = 1.0;
    computedConstants[205] = 3.0;
    algebraic[3] = 2.0;
    algebraic[4] = 1.0;
}
...
void computeComputedConstants(double *constants, double *computedConstants)
{
    ...
    computedConstants[33] = pow(constants[1], constants[0]) || (constants[2] > constants[3]);
    computedConstants[34] = pow(constants[1], 1.0/constants[0]) || (constants[2] > constants[3]);
    ...
    computedConstants[39] = (constants[1] < constants[0]) || pow(constants[2], constants[3]);
    computedConstants[40] = (constants[1] < constants[0]) || pow(constants[2], 1.0/constants[3]);
    computedConstants[41] = constants[1]/(constants[0] || constants[2]);
    computedConstants[42] = xor(constants[1], constants[0]);
    computedConstants[43] = xor(constants[1], xor(constants[0], constants[2]));
    computedConstants[44] = xor(constants[1] < constants[0], constants[2] > constants[3]);
    computedConstants[45] = xor(constants[1]+constants[0], constants[2] > constants[3]);
    computedConstants[46] = xor(constants[1], constants[0] > constants[2]);
    ...
    computedConstants[49] = xor(pow(constants[1], constants[0]), constants[2] > constants[3]);
    computedConstants[50] = xor(pow(constants[1], 1.0/constants[0]), constants[2] > constants[3]);
    computedConstants[51] = xor(constants[1] < constants[0], constants[2]+constants[3]);
    computedConstants[52] = xor(constants[1] < constants[0], constants[2]);
    ...
    computedConstants[55] = xor(constants[1] < constants[0], pow(constants[2], constants[3]));
    computedConstants[56] = xor(constants[1] < constants[0], pow(constants[2], 1.0/constants[3]));
    ...
    computedConstants[93] = pow(constants[1], 2.0);
    computedConstants[94] = pow(constants[1], 3.0);
    computedConstants[95] = pow(constants[1], constants[0]);
    computedConstants[96] = pow(constants[1] <= constants[0], constants[2] >= constants[3]);
    computedConstants[97] = pow(constants[1]+constants[0], constants[2] >= constants[3]);
    computedConstants[98] = pow(constants[1], constants[0] >= constants[2]);
    computedConstants[99] = pow(constants[1]-constants[0], constants[2] >= constants[3]);
    computedConstants[100] = pow(-constants[1], constants[0] >= constants[2]);
    computedConstants[101] = pow(constants[1]*constants[0], constants[2] >= constants[3]);
    computedConstants[102] = pow(constants[1]/constants[0], constants[2] >= constants[3]);
    computedConstants[103] = pow(constants[1] <= constants[0], constants[2]+constants[3]);
    computedConstants[104] = pow(constants[1] <= constants[0], constants[2]);
    computedConstants[105] = pow(constants[1] <= constants[0], constants[2]-constants[3]);
    computedConstants[106] = pow(constants[1] <= constants[0], -constants[2]);
    computedConstants[107] = pow(constants[1] <= constants[0], constants[2]*constants[3]);
    computedConstants[108] = pow(constants[1] <= constants[0], constants[2]/constants[3]);
    computedConstants[109] = pow(constants[1] <= constants[0], pow(constants[2], constants[3]));
    computedConstants[110] = pow(constants[1] <= constants[0], pow(constants[2], 1.0/constants[3]));
    computedConstants[111] = sqrt(constants[1]);
    computedConstants[112] = sqrt(constants[1]);
    computedConstants[113] = pow(constants[1], 1.0/0.5);
    computedConstants[114] = pow(constants[1], 1.0/3.0);
    computedConstants[115] = pow(constants[1], 1.0/constants[0]);
    computedConstants[116] = pow(constants[1] < constants[0], 1.0/(constants[3] > constants[2]));
    computedConstants[117] = pow(constants[1]+constants[0], 1.0/(constants[3] > constants[2]));
    computedConstants[118] = pow(constants[1], 1.0/(constants[2] > constants[0]));
    ...
    computedConstants[122] = pow(constants[1]/constants[0], 1.0/(constants[3] > constants[2]));
    computedConstants[123] = pow(constants[1] < constants[0], 1.0/(constants[2]+constants[3]));
    computedConstants[124] = pow(constants[1] < constants[0], 1.0/constants[2]);
    ...
    computedConstants[128] = pow(constants[1] < constants[0], 1.0/(constants[2]/constants[3]));
    computedConstants[129] = pow(constants[1] < constants[0], 1.0/pow(constants[2], constants[3]));
    computedConstants[130] = pow(constants[1] < constants[0], 1.0/pow(constants[2], 1.0/constants[3]));
    ...
    computedConstants[170] = (constants[1] > constants[0])?constants[1]:NAN;
    computedConstants[171] = (constants[1] < constants[0])?constants[1]:NAN;
    computedConstants[172] = constants[1];
    computedConstants[173] = (constants[1] > constants[0])?constants[1]:constants[2];
    computedConstants[174] = (constants[1] > constants[0])?constants[1]:(constants[2] > constants[3])?constants[2]:(constants[4] > constants[5])?constants[4]:NAN;
    computedConstants[175] = (constants[1] < constants[0])?constants[1]:(constants[2] > constants[3])?constants[2]:(constants[4] > constants[5])?constants[4]:NAN;
    computedConstants[176] = (constants[1] > constants[0])?constants[1]:(constants[2] > constants[3])?constants[2]:(constants[4] > constants[5])?constants[4]:constants[6];
    computedConstants[177] = 123.0+((constants[1] > constants[0])?constants[1]:NAN);
    computedConstants[178] = 123.0+((constants[1] < constants[0])?constants[1]:NAN);
    computedConstants[183] = constants[1];
    computedConstants[190] = (constants[1] && constants[0])+((constants[2] > constants[3])?constants[0]:NAN)+constants[4]+(constants[5] && constants[6]);
    computedConstants[191] = (constants[1] && constants[0])+((constants[2] < constants[3])?constants[0]:NAN)+constants[4]+(constants[5] && constants[6]);
    computedConstants[192] = (constants[1] && constants[0])-(((constants[2] > constants[3])?constants[0]:NAN)-(constants[4]-((constants[2] > constants[3])?constants[0]:NAN)))-(constants[5] && constants[6]);
    computedConstants[193] = (constants[1] && constants[0])-(((constants[2] < constants[3])?constants[0]:NAN)-(constants[4]-((constants[2] < constants[3])?constants[0]:NAN)))-(constants[5] && constants[6]);
    computedConstants[194] = (constants[1] && constants[0])*((constants[2] > constants[3])?constants[0]:NAN)*constants[4]*((constants[2] > constants[3])?constants[0]:NAN)*(constants[5] && constants[6]);
    computedConstants[195] = (constants[1] && constants[0])*((constants[2] < constants[3])?constants[0]:NAN)*constants[4]*((constants[2] < constants[3])?constants[0]:NAN)*(constants[5] && constants[6]);
    computedConstants[196] = (constants[1] && constants[0])/(((constants[2] > constants[3])?constants[0]:NAN)/(constants[4]/((constants[2] > constants[3])?constants[0]:NAN)));
    computedConstants[197] = (constants[1] && constants[0])/(((constants[2] < constants[3])?constants[0]:NAN)/(constants[4]/((constants[2] < constants[3])?constants[0]:NAN)));
    computedConstants[198] = (constants[1] || constants[0]) && xor(constants[1], constants[0]) && ((constants[2] > constants[3])?constants[0]:NAN) && constants[4] && ((constants[2] > constants[3])?constants[0]:NAN) && xor(constants[1], constants[0]) && (constants[1] || constants[0]);
    computedConstants[199] = (constants[1] && constants[0]) || xor(constants[1], constants[0]) || ((constants[2] > constants[3])?constants[0]:NAN) || constants[4] || ((constants[2] > constants[3])?constants[0]:NAN) || xor(constants[1], constants[0]) || (constants[1] && constants[0]);
    computedConstants[200] = xor(constants[1] && constants[0], xor(constants[1] || constants[0], xor((constants[2] > constants[3])?constants[0]:NAN, xor(xor(xor(constants[4], (constants[2] > constants[3])?constants[0]:NAN), constants[1] || constants[0]), constants[1] && constants[0]))));
    computedConstants[201] = pow(constants[1] && constants[0], pow((constants[2] > constants[3])?constants[0]:NAN, pow(pow(constants[4], (constants[2] > constants[3])?constants[0]:NAN), constants[1] && constants[0])));
    computedConstants[202] = pow(pow(pow(constants[1] && constants[0], 1.0/pow((constants[2] > constants[3])?constants[0]:NAN, 1.0/constants[4])), 1.0/((constants[2] > constants[3])?constants[0]:NAN)), 1.0/(constants[1] && constants[0]));
    computedConstants[203] = -(constants[1] && constants[0])+-((constants[2] > constants[3])?constants[0]:NAN);
    computedConstants[204] = -(constants[1] && constants[0])+-((constants[2] < constants[3])?constants[0]:NAN);
}
...
void computeVariables(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraic, double *externals, ExternalVariable externalVariable)
{
    ...
    algebraic[1] = states[0] || states[0] || constants[1];
    algebraic[2] = constants[1]/xor(constants[0], states[0]);
