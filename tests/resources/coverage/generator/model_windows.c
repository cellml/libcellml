...
void objectiveFunction0(double *u, double *f, void *data)
{
    ...
    f[0] = constants[1]+sin(algebraicVariables[1])+computedConstants[197]+states[0]+sin(algebraicVariables[0])-1.0;
    f[1] = sin(algebraicVariables[1])-computedConstants[197]-computedConstants[198]-computedConstants[199]-sin(algebraicVariables[0])-0.5;
}
