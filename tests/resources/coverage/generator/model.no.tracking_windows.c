...
void objectiveFunction0(double *u, double *f, void *data)
{
    ...
    f[0] = my_component_m+sin(algebraicVariables[1])+my_component_eqnComputedConstant3+states[0]+sin(algebraicVariables[0])-1.0;
    f[1] = sin(algebraicVariables[1])-my_component_eqnComputedConstant3-my_component_eqnComputedConstant2-my_component_eqnComputedConstant1-sin(algebraicVariables[0])-0.5;
}
