...
void objectiveFunction0(double *u, double *f, void *data)
{
    ...
    f[1] = -sin(algebraicVariables[0])+sin(algebraicVariables[1])-my_component_eqnComputedConstant1-my_component_eqnComputedConstant3-my_component_eqnComputedConstant2-0.5;
}
