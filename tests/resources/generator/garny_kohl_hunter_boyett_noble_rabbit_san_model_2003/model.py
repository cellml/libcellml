...
def compute_computed_constants(variables):
    variables[0] = 1.07*(3.0*variables[75]-0.1)/(3.0*(1.0+0.7745*exp(-(3.0*variables[75]-2.05)/0.295))) if eq_func(variables[76], 0.0) else variables[77]*variables[75]/(1.0+0.7745*exp(-(3.0*variables[75]-2.05)/0.295)) if eq_func(variables[76], 1.0) else 1.07*29.0*variables[75]/(30.0*(1.0+0.7745*exp(-(29.0*variables[75]-24.5)/1.95)))
    variables[1] = variables[78]+variables[0]*(variables[79]-variables[78])
    variables[2] = variables[83]+variables[0]*(variables[84]-variables[83]) if eq_func(variables[76], 0.0) else variables[87]+variables[0]*(variables[88]-variables[87]) if eq_func(variables[76], 1.0) else variables[85]+variables[0]*(variables[86]-variables[85])
    variables[3] = variables[89]+variables[0]*(variables[90]-variables[89]) if eq_func(variables[76], 0.0) else variables[93]+variables[0]*(variables[94]-variables[93]) if eq_func(variables[76], 1.0) else variables[91]+variables[0]*(variables[92]-variables[91])
    variables[4] = variables[95]+variables[0]*(variables[96]-variables[95]) if eq_func(variables[76], 0.0) else variables[99]+variables[0]*(variables[100]-variables[99]) if eq_func(variables[76], 1.0) else variables[97]+variables[0]*(variables[98]-variables[97])
    variables[5] = variables[101]+variables[0]*(variables[102]-variables[101]) if eq_func(variables[76], 0.0) else variables[105]+variables[0]*(variables[106]-variables[105]) if eq_func(variables[76], 1.0) else variables[103]+variables[0]*(variables[104]-variables[103])
    variables[7] = variables[113]+variables[0]*(variables[114]-variables[113]) if eq_func(variables[76], 0.0) else variables[117]+variables[0]*(variables[118]-variables[117]) if eq_func(variables[76], 1.0) else variables[115]+variables[0]*(variables[116]-variables[115])
    variables[9] = variables[122]+variables[0]*(variables[123]-variables[122]) if eq_func(variables[76], 0.0) else variables[126]+variables[0]*(variables[127]-variables[126]) if eq_func(variables[76], 1.0) else variables[124]+variables[0]*(variables[125]-variables[124])
    ...
    variables[14] = variables[80]*variables[81]/variables[82]*log((variables[119]+0.12*variables[110])/(variables[128]+0.12*variables[107])) if eq_func(variables[76], 0.0) else variables[80]*variables[81]/variables[82]*log((variables[119]+0.03*variables[110])/(variables[128]+0.03*variables[107]))
    variables[15] = variables[129]+variables[0]*(variables[130]-variables[129]) if eq_func(variables[76], 0.0) else variables[133]+variables[0]*(variables[134]-variables[133]) if eq_func(variables[76], 1.0) else variables[131]+variables[0]*(variables[132]-variables[131])
    variables[24] = variables[135]+variables[0]*(variables[136]-variables[135]) if eq_func(variables[76], 0.0) else variables[139]+variables[0]*(variables[140]-variables[139]) if eq_func(variables[76], 1.0) else variables[137]+variables[0]*(variables[138]-variables[137])
    variables[34] = variables[142]+variables[0]*(variables[143]-variables[142]) if eq_func(variables[76], 0.0) else variables[146]+variables[0]*(variables[147]-variables[146]) if eq_func(variables[76], 1.0) else variables[144]+variables[0]*(variables[145]-variables[144])
    variables[44] = variables[149]+variables[0]*(variables[150]-variables[149]) if eq_func(variables[76], 0.0) else variables[153]+variables[0]*(variables[154]-variables[153]) if eq_func(variables[76], 1.0) else variables[151]+variables[0]*(variables[152]-variables[151])
    variables[45] = variables[155]+variables[0]*(variables[156]-variables[155]) if eq_func(variables[76], 0.0) else variables[159]+variables[0]*(variables[160]-variables[159]) if eq_func(variables[76], 1.0) else variables[157]+variables[0]*(variables[158]-variables[157])
    variables[52] = variables[161]+variables[0]*(variables[162]-variables[161]) if eq_func(variables[76], 0.0) else variables[165]+variables[0]*(variables[166]-variables[165]) if eq_func(variables[76], 1.0) else variables[163]+variables[0]*(variables[164]-variables[163])
    variables[58] = 0.002 if eq_func(variables[76], 0.0) else 0.002 if eq_func(variables[76], 1.0) else 0.006
    variables[60] = variables[167]+variables[0]*(variables[168]-variables[167]) if eq_func(variables[76], 0.0) else variables[171]+variables[0]*(variables[172]-variables[171]) if eq_func(variables[76], 1.0) else variables[169]+variables[0]*(variables[170]-variables[169])
    variables[64] = variables[173]+variables[0]*(variables[174]-variables[173]) if eq_func(variables[76], 0.0) else variables[177]+variables[0]*(variables[178]-variables[177]) if eq_func(variables[76], 1.0) else variables[175]+variables[0]*(variables[176]-variables[175])
    variables[66] = variables[179]+variables[0]*(variables[180]-variables[179]) if eq_func(variables[76], 0.0) else variables[183]+variables[0]*(variables[184]-variables[183]) if eq_func(variables[76], 1.0) else variables[181]+variables[0]*(variables[182]-variables[181])


def compute_rates(voi, states, rates, variables):
    variables[16] = pow(1.0/(1.0+exp(-states[14]/5.46)), 1.0/3.0) if eq_func(variables[76], 0.0) else pow(1.0/(1.0+exp(-(states[14]+30.32)/5.46)), 1.0/3.0)
    variables[17] = 0.0006247/(0.832*exp(-0.335*(states[14]+56.7))+0.627*exp(0.082*(states[14]+65.01)))+4.0e-5 if eq_func(variables[76], 0.0) else 0.0006247/(0.8322166*exp(-0.33566*(states[14]+56.7062))+0.6274*exp(0.0823*(states[14]+65.0131)))+4.569e-5
    ...
    variables[29] = 1.0/(1.0+exp(-(states[14]+23.1)/6.0)) if eq_func(variables[76], 0.0) else 1.0/(1.0+exp(-(states[14]+22.3+0.8*variables[0])/6.0)) if eq_func(variables[76], 1.0) else 1.0/(1.0+exp(-(states[14]+22.2)/6.0))
    variables[26] = -28.38*(states[14]+35.0)/(exp(-(states[14]+35.0)/2.5)-1.0)-84.9*states[14]/(exp(-0.208*states[14])-1.0) if eq_func(variables[76], 0.0) else -28.39*(states[14]+35.0)/(exp(-(states[14]+35.0)/2.5)-1.0)-84.9*states[14]/(exp(-0.208*states[14])-1.0) if eq_func(variables[76], 1.0) else -28.4*(states[14]+35.0)/(exp(-(states[14]+35.0)/2.5)-1.0)-84.9*states[14]/(exp(-0.208*states[14])-1.0)
    variables[27] = 11.43*(states[14]-5.0)/(exp(0.4*(states[14]-5.0))-1.0) if eq_func(variables[76], 1.0) else 11.42*(states[14]-5.0)/(exp(0.4*(states[14]-5.0))-1.0)
    ...
    variables[30] = 3.75*(states[14]+28.0)/(exp((states[14]+28.0)/4.0)-1.0) if eq_func(variables[76], 1.0) else 3.12*(states[14]+28.0)/(exp((states[14]+28.0)/4.0)-1.0)
    variables[31] = 30.0/(1.0+exp(-(states[14]+28.0)/4.0)) if eq_func(variables[76], 1.0) else 25.0/(1.0+exp(-(states[14]+28.0)/4.0))
    variables[32] = (1.2-0.2*variables[0])/(variables[30]+variables[31]) if eq_func(variables[76], 1.0) else 1.0/(variables[30]+variables[31])
    ...
    variables[40] = 15.3*exp(-(states[14]+71.0+0.7*variables[0])/83.3) if eq_func(variables[76], 1.0) else 15.3*exp(-(states[14]+71.7)/83.3)
    variables[41] = 15.0*exp((states[14]+71.0)/15.38) if eq_func(variables[76], 1.0) else 15.0*exp((states[14]+71.7)/15.38)
    ...
    variables[49] = 0.0101+0.06517/(0.57*exp(-0.08*(states[14]+49.0)))+2.4e-5*exp(0.1*(states[14]+50.93)) if eq_func(variables[76], 0.0) else 0.001/3.0*(30.31+195.5/(0.5686*exp(-0.08161*(states[14]+39.0+10.0*variables[0]))+0.7174*exp((0.2719-0.1719*variables[0])*1.0*(states[14]+40.93+10.0*variables[0])))) if eq_func(variables[76], 1.0) else 0.0101+0.06517/(0.5686*exp(-0.08161*(states[14]+39.0))+0.7174*exp(0.2719*(states[14]+40.93)))
    rates[7] = (variables[48]-states[7])/variables[49]
    variables[50] = 1.0/(1.0+exp(-(states[14]-10.93)/19.7))
    variables[51] = 0.001*(2.98+15.59/(1.037*exp(0.09*(states[14]+30.61))+0.369*exp(-0.12*(states[14]+23.84)))) if eq_func(variables[76], 0.0) else 0.0025*(1.191+7.838/(1.037*exp(0.09012*(states[14]+30.61))+0.369*exp(-0.119*(states[14]+23.84)))) if eq_func(variables[76], 1.0) else 0.001*(2.98+19.59/(1.037*exp(0.09012*(states[14]+30.61))+0.369*exp(-0.119*(states[14]+23.84))))
    rates[8] = (variables[50]-states[8])/variables[51]
    variables[54] = 1.0/(1.0+exp(-(states[14]+14.2)/10.6)) if neq_func(variables[76], 2.0) else 1.0/(1.0+exp(-(states[14]+13.2)/10.6))
    variables[55] = 1.0/(37.2*exp((states[14]-9.0)/15.9)+0.96*exp(-(states[14]-9.0)/22.5)) if neq_func(variables[76], 2.0) else 1.0/(37.2*exp((states[14]-10.0)/15.9)+0.96*exp(-(states[14]-10.0)/22.5))
    rates[9] = (variables[54]-states[9])/variables[55]
    variables[56] = variables[54]
    variables[57] = 1.0/(4.2*exp((states[14]-9.0)/17.0)+0.15*exp(-(states[14]-9.0)/21.6)) if neq_func(variables[76], 2.0) else 1.0/(4.2*exp((states[14]-10.0)/17.0)+0.15*exp(-(states[14]-10.0)/21.6))
    ...
    variables[68] = 1.0*exp(-(states[14]+78.91)/26.62) if eq_func(variables[76], 0.0) else 1.0*exp(-(states[14]+78.91)/26.63)
    ...
    variables[6] = variables[5]*(pow(variables[107], 3.0)*variables[109]*exp(0.03743*states[14]*variables[108])-pow(variables[110], 3.0)*variables[111]*exp(0.0374*states[14]*(variables[108]-1.0)))/(1.0+variables[112]*(variables[111]*pow(variables[110], 3.0)+variables[109]*pow(variables[107], 3.0))) if eq_func(variables[76], 0.0) else variables[5]*(pow(variables[107], 3.0)*variables[109]*exp(0.03743*states[14]*variables[108])-pow(variables[110], 3.0)*variables[111]*exp(0.03743*states[14]*(variables[108]-1.0)))/(1.0+variables[112]*(variables[111]*pow(variables[110], 3.0)+variables[109]*pow(variables[107], 3.0)))
    variables[67] = variables[66]*states[13]*(states[14]-variables[12]) if neq_func(variables[76], 2.0) else variables[66]*states[13]*(states[14]+102.0)
    variables[65] = variables[64]*states[13]*(states[14]-variables[11]) if neq_func(variables[76], 2.0) else variables[64]*states[13]*(states[14]-77.6)
    ...
    variables[18] = 0.0952*exp(-0.063*(states[14]+34.4))/(1.0+1.66*exp(-0.225*(states[14]+63.7)))+0.0869 if eq_func(variables[76], 0.0) else 0.09518*exp(-0.06306*(states[14]+34.4))/(1.0+1.662*exp(-0.2251*(states[14]+63.7)))+0.08693
