...
def compute_computed_constants(variables):
    variables[3] = 1.07*(3.0*variables[0]-0.1)/(3.0*(1.0+0.7745*exp(-(3.0*variables[0]-2.05)/0.295))) if eq_func(variables[1], 0.0) else variables[2]*variables[0]/(1.0+0.7745*exp(-(3.0*variables[0]-2.05)/0.295)) if eq_func(variables[1], 1.0) else 1.07*29.0*variables[0]/(30.0*(1.0+0.7745*exp(-(29.0*variables[0]-24.5)/1.95)))
    variables[6] = variables[4]+variables[3]*(variables[5]-variables[4])
    variables[31] = variables[25]+variables[3]*(variables[26]-variables[25]) if eq_func(variables[1], 0.0) else variables[29]+variables[3]*(variables[30]-variables[29]) if eq_func(variables[1], 1.0) else variables[27]+variables[3]*(variables[28]-variables[27])
    variables[39] = variables[33]+variables[3]*(variables[34]-variables[33]) if eq_func(variables[1], 0.0) else variables[37]+variables[3]*(variables[38]-variables[37]) if eq_func(variables[1], 1.0) else variables[35]+variables[3]*(variables[36]-variables[35])
    variables[47] = variables[41]+variables[3]*(variables[42]-variables[41]) if eq_func(variables[1], 0.0) else variables[45]+variables[3]*(variables[46]-variables[45]) if eq_func(variables[1], 1.0) else variables[43]+variables[3]*(variables[44]-variables[43])
    variables[55] = variables[49]+variables[3]*(variables[50]-variables[49]) if eq_func(variables[1], 0.0) else variables[53]+variables[3]*(variables[54]-variables[53]) if eq_func(variables[1], 1.0) else variables[51]+variables[3]*(variables[52]-variables[51])
    variables[68] = variables[62]+variables[3]*(variables[63]-variables[62]) if eq_func(variables[1], 0.0) else variables[66]+variables[3]*(variables[67]-variables[66]) if eq_func(variables[1], 1.0) else variables[64]+variables[3]*(variables[65]-variables[64])
    variables[78] = variables[72]+variables[3]*(variables[73]-variables[72]) if eq_func(variables[1], 0.0) else variables[76]+variables[3]*(variables[77]-variables[76]) if eq_func(variables[1], 1.0) else variables[74]+variables[3]*(variables[75]-variables[74])
    ...
    variables[80] = variables[22]*variables[23]/variables[24]*log((variables[69]+0.12*variables[58])/(variables[79]+0.12*variables[56])) if eq_func(variables[1], 0.0) else variables[22]*variables[23]/variables[24]*log((variables[69]+0.03*variables[58])/(variables[79]+0.03*variables[56]))
    variables[87] = variables[81]+variables[3]*(variables[82]-variables[81]) if eq_func(variables[1], 0.0) else variables[85]+variables[3]*(variables[86]-variables[85]) if eq_func(variables[1], 1.0) else variables[83]+variables[3]*(variables[84]-variables[83])
    variables[102] = variables[96]+variables[3]*(variables[97]-variables[96]) if eq_func(variables[1], 0.0) else variables[100]+variables[3]*(variables[101]-variables[100]) if eq_func(variables[1], 1.0) else variables[98]+variables[3]*(variables[99]-variables[98])
    variables[118] = variables[112]+variables[3]*(variables[113]-variables[112]) if eq_func(variables[1], 0.0) else variables[116]+variables[3]*(variables[117]-variables[116]) if eq_func(variables[1], 1.0) else variables[114]+variables[3]*(variables[115]-variables[114])
    variables[134] = variables[128]+variables[3]*(variables[129]-variables[128]) if eq_func(variables[1], 0.0) else variables[132]+variables[3]*(variables[133]-variables[132]) if eq_func(variables[1], 1.0) else variables[130]+variables[3]*(variables[131]-variables[130])
    variables[141] = variables[135]+variables[3]*(variables[136]-variables[135]) if eq_func(variables[1], 0.0) else variables[139]+variables[3]*(variables[140]-variables[139]) if eq_func(variables[1], 1.0) else variables[137]+variables[3]*(variables[138]-variables[137])
    variables[152] = variables[146]+variables[3]*(variables[147]-variables[146]) if eq_func(variables[1], 0.0) else variables[150]+variables[3]*(variables[151]-variables[150]) if eq_func(variables[1], 1.0) else variables[148]+variables[3]*(variables[149]-variables[148])
    variables[158] = 0.002 if eq_func(variables[1], 0.0) else 0.002 if eq_func(variables[1], 1.0) else 0.006
    variables[166] = variables[160]+variables[3]*(variables[161]-variables[160]) if eq_func(variables[1], 0.0) else variables[164]+variables[3]*(variables[165]-variables[164]) if eq_func(variables[1], 1.0) else variables[162]+variables[3]*(variables[163]-variables[162])
    variables[175] = variables[169]+variables[3]*(variables[170]-variables[169]) if eq_func(variables[1], 0.0) else variables[173]+variables[3]*(variables[174]-variables[173]) if eq_func(variables[1], 1.0) else variables[171]+variables[3]*(variables[172]-variables[171])
    variables[182] = variables[176]+variables[3]*(variables[177]-variables[176]) if eq_func(variables[1], 0.0) else variables[180]+variables[3]*(variables[181]-variables[180]) if eq_func(variables[1], 1.0) else variables[178]+variables[3]*(variables[179]-variables[178])
...
def compute_rates(voi, states, rates, variables):
    ...
    variables[91] = 0.0952*exp(-0.063*(states[0]+34.4))/(1.0+1.66*exp(-0.225*(states[0]+63.7)))+0.0869 if eq_func(variables[1], 0.0) else 0.09518*exp(-0.06306*(states[0]+34.4))/(1.0+1.662*exp(-0.2251*(states[0]+63.7)))+0.08693
    ...
    variables[89] = 0.0006247/(0.832*exp(-0.335*(states[0]+56.7))+0.627*exp(0.082*(states[0]+65.01)))+4.0e-5 if eq_func(variables[1], 0.0) else 0.0006247/(0.8322166*exp(-0.33566*(states[0]+56.7062))+0.6274*exp(0.0823*(states[0]+65.0131)))+4.569e-5
    variables[90] = pow(1.0/(1.0+exp(-states[0]/5.46)), 1.0/3.0) if eq_func(variables[1], 0.0) else pow(1.0/(1.0+exp(-(states[0]+30.32)/5.46)), 1.0/3.0)
    ...
    variables[107] = 11.43*(states[0]-5.0)/(exp(0.4*(states[0]-5.0))-1.0) if eq_func(variables[1], 1.0) else 11.42*(states[0]-5.0)/(exp(0.4*(states[0]-5.0))-1.0)
    variables[106] = -28.38*(states[0]+35.0)/(exp(-(states[0]+35.0)/2.5)-1.0)-84.9*states[0]/(exp(-0.208*states[0])-1.0) if eq_func(variables[1], 0.0) else -28.39*(states[0]+35.0)/(exp(-(states[0]+35.0)/2.5)-1.0)-84.9*states[0]/(exp(-0.208*states[0])-1.0) if eq_func(variables[1], 1.0) else -28.4*(states[0]+35.0)/(exp(-(states[0]+35.0)/2.5)-1.0)-84.9*states[0]/(exp(-0.208*states[0])-1.0)
    variables[104] = 2.0/(variables[106]+variables[107])
    variables[105] = 1.0/(1.0+exp(-(states[0]+23.1)/6.0)) if eq_func(variables[1], 0.0) else 1.0/(1.0+exp(-(states[0]+22.3+0.8*variables[3])/6.0)) if eq_func(variables[1], 1.0) else 1.0/(1.0+exp(-(states[0]+22.2)/6.0))
    rates[4] = (variables[105]-states[4])/variables[104]
    variables[111] = 30.0/(1.0+exp(-(states[0]+28.0)/4.0)) if eq_func(variables[1], 1.0) else 25.0/(1.0+exp(-(states[0]+28.0)/4.0))
    variables[110] = 3.75*(states[0]+28.0)/(exp((states[0]+28.0)/4.0)-1.0) if eq_func(variables[1], 1.0) else 3.12*(states[0]+28.0)/(exp((states[0]+28.0)/4.0)-1.0)
    variables[108] = (1.2-0.2*variables[3])/(variables[110]+variables[111]) if eq_func(variables[1], 1.0) else 1.0/(variables[110]+variables[111])
    ...
    variables[127] = 15.0*exp((states[0]+71.0)/15.38) if eq_func(variables[1], 1.0) else 15.0*exp((states[0]+71.7)/15.38)
    variables[126] = 15.3*exp(-(states[0]+71.0+0.7*variables[3])/83.3) if eq_func(variables[1], 1.0) else 15.3*exp(-(states[0]+71.7)/83.3)
    ...
    variables[142] = 0.0101+0.06517/(0.57*exp(-0.08*(states[0]+49.0)))+2.4e-5*exp(0.1*(states[0]+50.93)) if eq_func(variables[1], 0.0) else 0.001/3.0*(30.31+195.5/(0.5686*exp(-0.08161*(states[0]+39.0+10.0*variables[3]))+0.7174*exp((0.2719-0.1719*variables[3])*1.0*(states[0]+40.93+10.0*variables[3])))) if eq_func(variables[1], 1.0) else 0.0101+0.06517/(0.5686*exp(-0.08161*(states[0]+39.0))+0.7174*exp(0.2719*(states[0]+40.93)))
    variables[143] = 1.0/(1.0+exp((states[0]+59.37)/13.1))
    rates[9] = (variables[143]-states[9])/variables[142]
    variables[144] = 0.001*(2.98+15.59/(1.037*exp(0.09*(states[0]+30.61))+0.369*exp(-0.12*(states[0]+23.84)))) if eq_func(variables[1], 0.0) else 0.0025*(1.191+7.838/(1.037*exp(0.09012*(states[0]+30.61))+0.369*exp(-0.119*(states[0]+23.84)))) if eq_func(variables[1], 1.0) else 0.001*(2.98+19.59/(1.037*exp(0.09012*(states[0]+30.61))+0.369*exp(-0.119*(states[0]+23.84))))
    variables[145] = 1.0/(1.0+exp(-(states[0]-10.93)/19.7))
    rates[8] = (variables[145]-states[8])/variables[144]
    variables[154] = 1.0/(37.2*exp((states[0]-9.0)/15.9)+0.96*exp(-(states[0]-9.0)/22.5)) if neq_func(variables[1], 2.0) else 1.0/(37.2*exp((states[0]-10.0)/15.9)+0.96*exp(-(states[0]-10.0)/22.5))
    variables[155] = 1.0/(1.0+exp(-(states[0]+14.2)/10.6)) if neq_func(variables[1], 2.0) else 1.0/(1.0+exp(-(states[0]+13.2)/10.6))
    rates[12] = (variables[155]-states[12])/variables[154]
    variables[156] = 1.0/(4.2*exp((states[0]-9.0)/17.0)+0.15*exp(-(states[0]-9.0)/21.6)) if neq_func(variables[1], 2.0) else 1.0/(4.2*exp((states[0]-10.0)/17.0)+0.15*exp(-(states[0]-10.0)/21.6))
    ...
    variables[184] = 1.0*exp(-(states[0]+78.91)/26.62) if eq_func(variables[1], 0.0) else 1.0*exp(-(states[0]+78.91)/26.63)
