...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    algebraicVariables[16] = (constants[1] == 0.0)?pow(1.0/(1.0+exp(-states[0]/5.46)), 0.333333333333333):pow(1.0/(1.0+exp((-states[0]-30.32)/5.46)), 0.333333333333333);
    ...
    algebraicVariables[38] = (constants[1] == 0.0)?0.0101+0.06517/(0.57*exp(-0.08*(states[0]+49.0)))+2.4e-5*exp(0.1*(states[0]+50.93)):(constants[1] == 1.0)?0.000333333333333333*(30.31+195.5/(0.5686*exp(-0.08161*(states[0]+39.0+10.0*computedConstants[0]))+0.7174*exp((0.2719-0.1719*computedConstants[0])*(states[0]+40.93+10.0*computedConstants[0])))):0.0101+0.06517/(0.5686*exp(-0.08161*(states[0]+39.0))+0.7174*exp(0.2719*(states[0]+40.93)));
    ...
    algebraicVariables[48] = exp(-states[0]/45.0);
    ...
    algebraicVariables[50] = exp((states[0]+75.13)/21.25);
    algebraicVariables[51] = (constants[1] == 0.0)?exp((-states[0]-78.91)/26.62):exp((-states[0]-78.91)/26.63);
