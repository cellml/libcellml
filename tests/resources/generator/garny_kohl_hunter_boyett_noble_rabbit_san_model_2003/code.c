...
const struct VariableInfo VOI_INFO = {"time", "second", "membrane"};
...
const struct VariableInfo VARIABLE_INFO[] = {
    ...
    {"i_Ca_p", "nanoA", "membrane"},
    {"E_Na", "millivolt", "sodium_background_current"},
    {"E_K", "millivolt", "potassium_background_current"},
    {"E_Ca", "millivolt", "calcium_background_current"},
    ...
    {"i_f_Na", "nanoA", "membrane"},
    {"i_f_K", "nanoA", "membrane"},
    ...
    {"i_b_Na", "nanoA", "membrane"},
    {"i_b_K", "nanoA", "membrane"},
    {"i_b_Ca", "nanoA", "membrane"},
    {"i_Na", "nanoA", "membrane"},
    {"i_K_r", "nanoA", "membrane"}
};
