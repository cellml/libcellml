...
const struct VARIABLE_INFO VARIABLE_VECTOR_INFORMATION_ARRAY[] = {
    {"E_Ca_L", "millivolt"},
    {"g_Ca_L_Centre_0DCapable", "microS"},
    {"g_Ca_L_Centre_1DCapable", "microS"},
    {"g_Ca_L_Centre_Published", "microS"},
    {"g_Ca_L_Periphery_0DCapable", "microS"},
    {"g_Ca_L_Periphery_1DCapable", "microS"},
    {"g_Ca_L_Periphery_Published", "microS"},
    {"E_Ca_T", "millivolt"},
    {"g_Ca_T_Centre_0DCapable", "microS"},
    {"g_Ca_T_Centre_1DCapable", "microS"},
    {"g_Ca_T_Centre_Published", "microS"},
    {"g_Ca_T_Periphery_0DCapable", "microS"},
    {"g_Ca_T_Periphery_1DCapable", "microS"},
    {"g_Ca_T_Periphery_Published", "microS"},
    {"g_b_Ca_Centre_0DCapable", "microS"},
    {"g_b_Ca_Centre_1DCapable", "microS"},
    {"g_b_Ca_Centre_Published", "microS"},
    {"g_b_Ca_Periphery_0DCapable", "microS"},
    {"g_b_Ca_Periphery_1DCapable", "microS"},
    {"g_b_Ca_Periphery_Published", "microS"},
    {"g_sus_Centre_0DCapable", "microS"},
    {"g_sus_Centre_1DCapable", "microS"},
    {"g_sus_Centre_Published", "microS"},
    {"g_sus_Periphery_0DCapable", "microS"},
    {"g_sus_Periphery_1DCapable", "microS"},
    {"g_sus_Periphery_Published", "microS"},
    {"g_to_Centre_0DCapable", "microS"},
    {"g_to_Centre_1DCapable", "microS"},
    {"g_to_Centre_Published", "microS"},
    {"g_to_Periphery_0DCapable", "microS"},
    {"g_to_Periphery_1DCapable", "microS"},
    {"g_to_Periphery_Published", "microS"},
    {"g_f_K_Centre_0DCapable", "microS"},
    {"g_f_K_Centre_1DCapable", "microS"},
    {"g_f_K_Centre_Published", "microS"},
    {"g_f_K_Periphery_0DCapable", "microS"},
    {"g_f_K_Periphery_1DCapable", "microS"},
    {"g_f_K_Periphery_Published", "microS"},
    {"g_f_Na_Centre_0DCapable", "microS"},
    {"g_f_Na_Centre_1DCapable", "microS"},
    {"g_f_Na_Centre_Published", "microS"},
    {"g_f_Na_Periphery_0DCapable", "microS"},
    {"g_f_Na_Periphery_1DCapable", "microS"},
    {"g_f_Na_Periphery_Published", "microS"},
    {"Ca_i", "millimolar"},
    {"Ca_o", "millimolar"},
    {"K_i", "millimolar"},
    {"K_o", "millimolar"},
    ...
    {"CmPeriphery", "microF"},
    {"F", "coulomb_per_mole"},
    {"FCellConstant", "dimensionless"},
    {"R", "millijoule_per_mole_kelvin"},
    {"T", "kelvin"},
    {"Version", "dimensionless"},
    {"dCell", "dimensionless"},
    {"i_Ca_p_max_Centre_0DCapable", "nanoA"},
    {"i_Ca_p_max_Centre_1DCapable", "nanoA"},
    {"i_Ca_p_max_Centre_Published", "nanoA"},
    {"i_Ca_p_max_Periphery_0DCapable", "nanoA"},
    {"i_Ca_p_max_Periphery_1DCapable", "nanoA"},
    {"i_Ca_p_max_Periphery_Published", "nanoA"},
    {"g_b_K_Centre_0DCapable", "microS"},
    {"g_b_K_Centre_1DCapable", "microS"},
    {"g_b_K_Centre_Published", "microS"},
    {"g_b_K_Periphery_0DCapable", "microS"},
    {"g_b_K_Periphery_1DCapable", "microS"},
    {"g_b_K_Periphery_Published", "microS"},
    {"g_K_r_Centre_0DCapable", "microS"},
    {"g_K_r_Centre_1DCapable", "microS"},
    {"g_K_r_Centre_Published", "microS"},
    {"g_K_r_Periphery_0DCapable", "microS"},
    {"g_K_r_Periphery_1DCapable", "microS"},
    {"g_K_r_Periphery_Published", "microS"},
    {"g_K_s_Centre_0DCapable", "microS"},
    {"g_K_s_Centre_1DCapable", "microS"},
    {"g_K_s_Centre_Published", "microS"},
    {"g_K_s_Periphery_0DCapable", "microS"},
    {"g_K_s_Periphery_1DCapable", "microS"},
    {"g_K_s_Periphery_Published", "microS"},
    {"g_b_Na_Centre_0DCapable", "microS"},
    {"g_b_Na_Centre_1DCapable", "microS"},
    {"g_b_Na_Centre_Published", "microS"},
    {"g_b_Na_Periphery_0DCapable", "microS"},
    {"g_b_Na_Periphery_1DCapable", "microS"},
    {"g_b_Na_Periphery_Published", "microS"},
    {"d_NaCa", "dimensionless"},
    {"gamma_NaCa", "dimensionless"},
    {"k_NaCa_Centre_0DCapable", "nanoA"},
    {"k_NaCa_Centre_1DCapable", "nanoA"},
    {"k_NaCa_Centre_Published", "nanoA"},
    {"k_NaCa_Periphery_0DCapable", "nanoA"},
    {"k_NaCa_Periphery_1DCapable", "nanoA"},
    {"k_NaCa_Periphery_Published", "nanoA"},
    {"g_Na_Centre_0DCapable", "microlitre_per_second"},
    {"g_Na_Centre_1DCapable", "microlitre_per_second"},
    {"g_Na_Centre_Published", "microlitre_per_second"},
    {"g_Na_Periphery_0DCapable", "microlitre_per_second"},
    {"g_Na_Periphery_1DCapable", "microlitre_per_second"},
    {"g_Na_Periphery_Published", "microlitre_per_second"},
    {"K_m_K", "millimolar"},
    {"K_m_Na", "millimolar"},
    {"i_p_max_Centre_0DCapable", "nanoA"},
    {"i_p_max_Centre_1DCapable", "nanoA"},
    {"i_p_max_Centre_Published", "nanoA"},
    {"i_p_max_Periphery_0DCapable", "nanoA"},
    {"i_p_max_Periphery_1DCapable", "nanoA"},
    {"i_p_max_Periphery_Published", "nanoA"},
    {"FCell", "dimensionless"},
    {"Cm", "microF"},
    {"g_b_Na", "microS"},
    {"g_b_K", "microS"},
    ...
    {"i_NaCa", "nanoA"},
    {"i_p", "nanoA"},
    {"m_infinity", "dimensionless"},
    {"tau_m", "second"},
    {"F_Na", "dimensionless"},
    {"h", "dimensionless"},
    {"h1_infinity", "dimensionless"},
    {"h2_infinity", "dimensionless"},
    {"tau_h1", "second"},
    {"tau_h2", "second"},
    {"i_Ca_L", "nanoA"},
    {"alpha_d_L", "per_second"},
    {"beta_d_L", "per_second"},
    {"tau_d_L", "second"},
    {"d_L_infinity", "dimensionless"},
    {"alpha_f_L", "per_second"},
    {"beta_f_L", "per_second"},
    {"tau_f_L", "second"},
    {"f_L_infinity", "dimensionless"},
    {"i_Ca_T", "nanoA"},
    {"alpha_d_T", "per_second"},
    {"beta_d_T", "per_second"},
    {"tau_d_T", "second"},
    {"d_T_infinity", "dimensionless"},
    {"alpha_f_T", "per_second"},
    {"beta_f_T", "per_second"},
    {"tau_f_T", "second"},
    {"f_T_infinity", "dimensionless"},
    {"i_to", "nanoA"},
    {"i_sus", "nanoA"},
    {"q_infinity", "dimensionless"},
    {"tau_q", "second"},
    {"r_infinity", "dimensionless"},
    {"tau_r", "second"},
    {"P_a", "dimensionless"},
    {"P_af_infinity", "dimensionless"},
    {"tau_P_af", "second"},
    {"P_as_infinity", "dimensionless"},
    {"tau_P_as", "second"},
    {"P_i_infinity", "dimensionless"},
    {"i_K_s", "nanoA"},
    {"alpha_xs", "per_second"},
    {"beta_xs", "per_second"},
    {"i_f_Na", "nanoA"},
