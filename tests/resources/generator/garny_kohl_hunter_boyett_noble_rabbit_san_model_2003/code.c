...
const struct VariableInfo STATE_VECTOR_INFORMATION_ARRAY[] = {
    ...
    {"L_type_Ca_channel_d_gate", "d_L", "dimensionless"},
    {"L_type_Ca_channel_f_gate", "f_L", "dimensionless"},
    {"T_type_Ca_channel_d_gate", "d_T", "dimensionless"},
    {"T_type_Ca_channel_f_gate", "f_T", "dimensionless"},
    {"four_AP_sensitive_currents_q_gate", "q", "dimensionless"},
    {"four_AP_sensitive_currents_r_gate", "r", "dimensionless"},
    {"rapid_delayed_rectifying_potassium_current_P_af_gate", "P_af", "dimensionless"},
    {"rapid_delayed_rectifying_potassium_current_P_as_gate", "P_as", "dimensionless"},
...
const struct VariableInfo VARIABLE_VECTOR_INFORMATION_ARRAY[] = {
    ...
    {"L_type_Ca_channel", "g_Ca_L_Centre_Published", "microS"},
    {"L_type_Ca_channel", "g_Ca_L_Periphery_0DCapable", "microS"},
    {"L_type_Ca_channel", "g_Ca_L_Periphery_1DCapable", "microS"},
    {"L_type_Ca_channel", "g_Ca_L_Periphery_Published", "microS"},
    {"T_type_Ca_channel", "E_Ca_T", "millivolt"},
    {"T_type_Ca_channel", "g_Ca_T_Centre_0DCapable", "microS"},
    {"T_type_Ca_channel", "g_Ca_T_Centre_1DCapable", "microS"},
    {"T_type_Ca_channel", "g_Ca_T_Centre_Published", "microS"},
    {"T_type_Ca_channel", "g_Ca_T_Periphery_0DCapable", "microS"},
    {"T_type_Ca_channel", "g_Ca_T_Periphery_1DCapable", "microS"},
    {"T_type_Ca_channel", "g_Ca_T_Periphery_Published", "microS"},
    {"calcium_background_current", "g_b_Ca_Centre_0DCapable", "microS"},
    {"calcium_background_current", "g_b_Ca_Centre_1DCapable", "microS"},
    {"calcium_background_current", "g_b_Ca_Centre_Published", "microS"},
    {"calcium_background_current", "g_b_Ca_Periphery_0DCapable", "microS"},
    {"calcium_background_current", "g_b_Ca_Periphery_1DCapable", "microS"},
    {"calcium_background_current", "g_b_Ca_Periphery_Published", "microS"},
    {"four_AP_sensitive_currents", "g_sus_Centre_0DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_sus_Centre_1DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_sus_Centre_Published", "microS"},
    {"four_AP_sensitive_currents", "g_sus_Periphery_0DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_sus_Periphery_1DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_sus_Periphery_Published", "microS"},
    {"four_AP_sensitive_currents", "g_to_Centre_0DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_to_Centre_1DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_to_Centre_Published", "microS"},
    {"four_AP_sensitive_currents", "g_to_Periphery_0DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_to_Periphery_1DCapable", "microS"},
    {"four_AP_sensitive_currents", "g_to_Periphery_Published", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K_Centre_0DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K_Centre_1DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K_Centre_Published", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K_Periphery_0DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K_Periphery_1DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K_Periphery_Published", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na_Centre_0DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na_Centre_1DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na_Centre_Published", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na_Periphery_0DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na_Periphery_1DCapable", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na_Periphery_Published", "microS"},
    {"ionic_concentrations", "Ca_i", "millimolar"},
    {"ionic_concentrations", "Ca_o", "millimolar"},
    {"ionic_concentrations", "K_i", "millimolar"},
    {"ionic_concentrations", "K_o", "millimolar"},
    {"ionic_concentrations", "Na_i", "millimolar"},
    {"ionic_concentrations", "Na_o", "millimolar"},
    {"membrane", "CmCentre", "microF"},
    {"membrane", "CmPeriphery", "microF"},
    {"membrane", "F", "coulomb_per_mole"},
    {"membrane", "FCellConstant", "dimensionless"},
    {"membrane", "R", "millijoule_per_mole_kelvin"},
    {"membrane", "T", "kelvin"},
    {"membrane", "Version", "dimensionless"},
    {"membrane", "dCell", "dimensionless"},
    {"persistent_calcium_current", "i_Ca_p_max_Centre_0DCapable", "nanoA"},
    {"persistent_calcium_current", "i_Ca_p_max_Centre_1DCapable", "nanoA"},
    {"persistent_calcium_current", "i_Ca_p_max_Centre_Published", "nanoA"},
    {"persistent_calcium_current", "i_Ca_p_max_Periphery_0DCapable", "nanoA"},
    {"persistent_calcium_current", "i_Ca_p_max_Periphery_1DCapable", "nanoA"},
    {"persistent_calcium_current", "i_Ca_p_max_Periphery_Published", "nanoA"},
    {"potassium_background_current", "g_b_K_Centre_0DCapable", "microS"},
    {"potassium_background_current", "g_b_K_Centre_1DCapable", "microS"},
    {"potassium_background_current", "g_b_K_Centre_Published", "microS"},
    {"potassium_background_current", "g_b_K_Periphery_0DCapable", "microS"},
    {"potassium_background_current", "g_b_K_Periphery_1DCapable", "microS"},
    {"potassium_background_current", "g_b_K_Periphery_Published", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r_Centre_0DCapable", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r_Centre_1DCapable", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r_Centre_Published", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r_Periphery_0DCapable", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r_Periphery_1DCapable", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r_Periphery_Published", "microS"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s_Centre_0DCapable", "microS"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s_Centre_1DCapable", "microS"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s_Centre_Published", "microS"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s_Periphery_0DCapable", "microS"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s_Periphery_1DCapable", "microS"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s_Periphery_Published", "microS"},
    {"sodium_background_current", "g_b_Na_Centre_0DCapable", "microS"},
    {"sodium_background_current", "g_b_Na_Centre_1DCapable", "microS"},
    {"sodium_background_current", "g_b_Na_Centre_Published", "microS"},
    {"sodium_background_current", "g_b_Na_Periphery_0DCapable", "microS"},
    {"sodium_background_current", "g_b_Na_Periphery_1DCapable", "microS"},
    {"sodium_background_current", "g_b_Na_Periphery_Published", "microS"},
    {"sodium_calcium_exchanger", "d_NaCa", "dimensionless"},
    {"sodium_calcium_exchanger", "gamma_NaCa", "dimensionless"},
    {"sodium_calcium_exchanger", "k_NaCa_Centre_0DCapable", "nanoA"},
    {"sodium_calcium_exchanger", "k_NaCa_Centre_1DCapable", "nanoA"},
    {"sodium_calcium_exchanger", "k_NaCa_Centre_Published", "nanoA"},
    {"sodium_calcium_exchanger", "k_NaCa_Periphery_0DCapable", "nanoA"},
    {"sodium_calcium_exchanger", "k_NaCa_Periphery_1DCapable", "nanoA"},
    {"sodium_calcium_exchanger", "k_NaCa_Periphery_Published", "nanoA"},
    {"sodium_current", "g_Na_Centre_0DCapable", "microlitre_per_second"},
    {"sodium_current", "g_Na_Centre_1DCapable", "microlitre_per_second"},
    {"sodium_current", "g_Na_Centre_Published", "microlitre_per_second"},
    {"sodium_current", "g_Na_Periphery_0DCapable", "microlitre_per_second"},
    {"sodium_current", "g_Na_Periphery_1DCapable", "microlitre_per_second"},
    {"sodium_current", "g_Na_Periphery_Published", "microlitre_per_second"},
    {"sodium_potassium_pump", "K_m_K", "millimolar"},
    {"sodium_potassium_pump", "K_m_Na", "millimolar"},
    {"sodium_potassium_pump", "i_p_max_Centre_0DCapable", "nanoA"},
    {"sodium_potassium_pump", "i_p_max_Centre_1DCapable", "nanoA"},
    {"sodium_potassium_pump", "i_p_max_Centre_Published", "nanoA"},
    {"sodium_potassium_pump", "i_p_max_Periphery_0DCapable", "nanoA"},
    {"sodium_potassium_pump", "i_p_max_Periphery_1DCapable", "nanoA"},
    {"sodium_potassium_pump", "i_p_max_Periphery_Published", "nanoA"},
    {"membrane", "FCell", "dimensionless"},
    {"membrane", "Cm", "microF"},
    {"sodium_background_current", "g_b_Na", "microS"},
    {"potassium_background_current", "g_b_K", "microS"},
    {"calcium_background_current", "g_b_Ca", "microS"},
    {"sodium_calcium_exchanger", "k_NaCa", "nanoA"},
    {"sodium_potassium_pump", "i_p_max", "nanoA"},
    {"persistent_calcium_current", "i_Ca_p_max", "nanoA"},
    {"membrane", "i_Ca_p", "nanoA"},
    {"sodium_background_current", "E_Na", "millivolt"},
    {"potassium_background_current", "E_K", "millivolt"},
    {"calcium_background_current", "E_Ca", "millivolt"},
    {"reversal_and_equilibrium_potentials", "E_K_s", "millivolt"},
    {"sodium_current", "g_Na", "microlitre_per_second"},
    {"L_type_Ca_channel", "g_Ca_L", "microS"},
    {"T_type_Ca_channel", "g_Ca_T", "microS"},
    {"four_AP_sensitive_currents", "g_to", "microS"},
    {"four_AP_sensitive_currents", "g_sus", "microS"},
    {"rapid_delayed_rectifying_potassium_current", "g_K_r", "microS"},
    {"rapid_delayed_rectifying_potassium_current_P_i_gate", "tau_P_i", "second"},
    {"slow_delayed_rectifying_potassium_current", "g_K_s", "microS"},
    {"hyperpolarisation_activated_current", "g_f_Na", "microS"},
    {"hyperpolarisation_activated_current", "g_f_K", "microS"},
    {"membrane", "i_NaCa", "nanoA"},
    {"membrane", "i_p", "nanoA"},
    {"sodium_current_m_gate", "m_infinity", "dimensionless"},
    {"sodium_current_m_gate", "tau_m", "second"},
    {"sodium_current_h_gate", "F_Na", "dimensionless"},
    {"sodium_current", "h", "dimensionless"},
    {"sodium_current_h_gate", "h1_infinity", "dimensionless"},
    {"sodium_current_h_gate", "h2_infinity", "dimensionless"},
    {"sodium_current_h_gate", "tau_h1", "second"},
    {"sodium_current_h_gate", "tau_h2", "second"},
    {"membrane", "i_Ca_L", "nanoA"},
    {"L_type_Ca_channel_d_gate", "alpha_d_L", "per_second"},
    {"L_type_Ca_channel_d_gate", "beta_d_L", "per_second"},
    {"L_type_Ca_channel_d_gate", "tau_d_L", "second"},
    {"L_type_Ca_channel_d_gate", "d_L_infinity", "dimensionless"},
    {"L_type_Ca_channel_f_gate", "alpha_f_L", "per_second"},
    {"L_type_Ca_channel_f_gate", "beta_f_L", "per_second"},
    {"L_type_Ca_channel_f_gate", "tau_f_L", "second"},
    {"L_type_Ca_channel_f_gate", "f_L_infinity", "dimensionless"},
    {"membrane", "i_Ca_T", "nanoA"},
    {"T_type_Ca_channel_d_gate", "alpha_d_T", "per_second"},
    {"T_type_Ca_channel_d_gate", "beta_d_T", "per_second"},
    {"T_type_Ca_channel_d_gate", "tau_d_T", "second"},
    {"T_type_Ca_channel_d_gate", "d_T_infinity", "dimensionless"},
    {"T_type_Ca_channel_f_gate", "alpha_f_T", "per_second"},
    {"T_type_Ca_channel_f_gate", "beta_f_T", "per_second"},
    {"T_type_Ca_channel_f_gate", "tau_f_T", "second"},
    {"T_type_Ca_channel_f_gate", "f_T_infinity", "dimensionless"},
    {"membrane", "i_to", "nanoA"},
    {"membrane", "i_sus", "nanoA"},
    {"four_AP_sensitive_currents_q_gate", "q_infinity", "dimensionless"},
    {"four_AP_sensitive_currents_q_gate", "tau_q", "second"},
    {"four_AP_sensitive_currents_r_gate", "r_infinity", "dimensionless"},
    {"four_AP_sensitive_currents_r_gate", "tau_r", "second"},
    {"rapid_delayed_rectifying_potassium_current", "P_a", "dimensionless"},
    {"rapid_delayed_rectifying_potassium_current_P_af_gate", "P_af_infinity", "dimensionless"},
    {"rapid_delayed_rectifying_potassium_current_P_af_gate", "tau_P_af", "second"},
    {"rapid_delayed_rectifying_potassium_current_P_as_gate", "P_as_infinity", "dimensionless"},
    {"rapid_delayed_rectifying_potassium_current_P_as_gate", "tau_P_as", "second"},
    {"rapid_delayed_rectifying_potassium_current_P_i_gate", "P_i_infinity", "dimensionless"},
    {"membrane", "i_K_s", "nanoA"},
    {"slow_delayed_rectifying_potassium_current_xs_gate", "alpha_xs", "per_second"},
    {"slow_delayed_rectifying_potassium_current_xs_gate", "beta_xs", "per_second"},
    {"membrane", "i_f_Na", "nanoA"},
    {"membrane", "i_f_K", "nanoA"},
    {"hyperpolarisation_activated_current_y_gate", "alpha_y", "per_second"},
    {"hyperpolarisation_activated_current_y_gate", "beta_y", "per_second"},
    {"membrane", "i_b_Na", "nanoA"},
