...
const VariableInfoWithType VARIABLE_INFO[] = {
    ...
    {"g_K", "microS_per_cm2", "potassium_channel", CONSTANT},
    {"g_Na", "S_per_cm2", "sodium_channel", CONSTANT},
    ...
    {"i_Na", "milliA_per_cm2", "sodium_channel", ALGEBRAIC},
...
{
    variables[10] = 100000.0*(0.001*states[3]+0.025)/(exp((0.001*states[3]+0.025)/0.01)-1.0);
    variables[11] = 4000.0*exp(0.001*states[3]/0.018);
    rates[0] = 0.001*(variables[10]*(1.0-states[0])-variables[11]*states[0]);
    ...
    variables[5] = ((0.001*voi >= 0.01) && (0.001*voi <= 0.0105))?-20000.0:0.0;
