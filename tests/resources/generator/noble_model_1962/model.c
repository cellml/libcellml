...
{
    variables[1] = variables[5]*(states[0]-variables[4]);
    variables[7] = pow(states[2], 3.0)*states[1]*variables[6];
    variables[3] = (variables[7]+0.14)*(states[0]-variables[8]);
    variables[13] = 1.2*pow(states[3], 4.0);
    variables[14] = 1.2*exp((-states[0]-90.0)/50.0)+0.015*exp((states[0]+90.0)/60.0);
    variables[2] = (variables[14]+variables[13])*(states[0]+100.0);
    rates[0] = -(variables[3]+variables[2]+variables[1])/variables[0];
