...
def objective_function_1(u, f, data):
    ...
    f[0] = rates[0]-(-(-algebraic_variables[0]+algebraic_variables[3]+algebraic_variables[2]+algebraic_variables[1])/membrane_Cm)-0.0
...
def objective_function_2(u, f, data):
    ...
    f[0] = algebraic_variables[4]-(membrane_E_R-10.613)-0.0
...
def objective_function_3(u, f, data):
    ...
    f[0] = algebraic_variables[1]-leakage_current_g_L*(states[0]-algebraic_variables[4])-0.0
...
def objective_function_4(u, f, data):
    ...
    f[0] = algebraic_variables[5]-(membrane_E_R-115.0)-0.0
...
def objective_function_5(u, f, data):
    ...
    f[0] = algebraic_variables[3]-sodium_channel_g_Na*pow(states[2], 3.0)*states[1]*(states[0]-algebraic_variables[5])-0.0
...
def objective_function_7(u, f, data):
    ...
    f[0] = rates[2]-(sodium_channel_m_gate_alpha_m*(1.0-states[2])-algebraic_variables[6]*states[2])-0.0
...
def objective_function_11(u, f, data):
    ...
    f[0] = algebraic_variables[2]-potassium_channel_g_K*pow(states[3], 4.0)*(states[0]-potassium_channel_E_K)-0.0
