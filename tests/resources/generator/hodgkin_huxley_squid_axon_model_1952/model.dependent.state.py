...
def compute_variables(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    externalVariables[0] = external_variable(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, 0)
    algebraicVariables[1] = constants[2]*(externalVariables[0]-computed_constants[0])
    ...
    algebraicVariables[3] = constants[3]*pow(externalVariables[1], 3.0)*states[0]*(externalVariables[0]-computed_constants[1])
    ...
    algebraicVariables[2] = constants[4]*pow(states[1], 4.0)*(externalVariables[0]-computed_constants[2])
