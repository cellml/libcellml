...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraic_variables[7] = 1.0/(exp((external_variables[0]+30.0)/10.0)+1.0)
    algebraic_variables[6] = 0.07*exp(external_variables[0]/20.0)
    rates[0] = algebraic_variables[6]*(1.0-states[0])-algebraic_variables[7]*states[0]
    algebraic_variables[9] = 0.125*exp(external_variables[0]/80.0)
    algebraic_variables[8] = 0.01*(external_variables[0]+10.0)/(exp((external_variables[0]+10.0)/10.0)-1.0)
...
def compute_variables(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraic_variables[4] = 0.1*(external_variables[0]+25.0)/(exp((external_variables[0]+25.0)/10.0)-1.0)
    algebraic_variables[5] = 4.0*exp(external_variables[0]/18.0)
    algebraic_variables[2] = constants[4]*pow(states[1], 4.0)*(external_variables[0]-computed_constants[2])
