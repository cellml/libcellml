...
{
    double sodium_channel_i_Na = states[0]*states[1]*pow(states[2], 3.0)*constants[3]-states[1]*pow(states[2], 3.0)*constants[3]*computedConstants[1];
    ...
    rates[0] = (-potassium_channel_i_K-leakage_current_i_L+membrane_i_Stim-sodium_channel_i_Na)/constants[0];
