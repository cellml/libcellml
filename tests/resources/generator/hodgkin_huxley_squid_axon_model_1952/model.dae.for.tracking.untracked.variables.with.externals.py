...
def objective_function_2(u, f, data):
    ...
    f[0] = algebraicVariables[3]-(membrane_E_R-10.613)-0.0
...
def objective_function_3(u, f, data):
    ...
    f[0] = algebraicVariables[1]-leakage_current_g_L*(states[0]-algebraicVariables[3])-0.0
...
def objective_function_4(u, f, data):
    ...
    f[0] = algebraicVariables[4]-(membrane_E_R-115.0)-0.0
...
def objective_function_11(u, f, data):
    ...
    f[0] = algebraicVariables[2]-potassium_channel_g_K*pow(states[3], 4.0)*(states[0]-computed_constants[0])-0.0
