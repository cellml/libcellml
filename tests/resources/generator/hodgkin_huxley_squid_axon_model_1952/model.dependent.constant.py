...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraic_variables[1] = constants[1]*(states[0]-computed_constants[0])
    algebraic_variables[2] = constants[2]*pow(states[3], 4.0)*(states[0]-computed_constants[2])
    algebraic_variables[3] = external_variables[1]*pow(states[2], 3.0)*states[1]*(states[0]-computed_constants[1])
    rates[0] = -(-algebraic_variables[0]+algebraic_variables[3]+algebraic_variables[2]+algebraic_variables[1])/external_variables[0]
