...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraicVariables[1] = constants[1]*(states[0]-computed_constants[0])
    algebraicVariables[2] = constants[2]*pow(states[3], 4.0)*(states[0]-computed_constants[2])
    algebraicVariables[3] = externalVariables[1]*pow(states[2], 3.0)*states[1]*(states[0]-computed_constants[1])
    rates[0] = -(-algebraicVariables[0]+algebraicVariables[3]+algebraicVariables[2]+algebraicVariables[1])/externalVariables[0]
