...
#include "model.dae.wo.cc.untracked.computed.constants.h"
...
void objectiveFunction2(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[1]-constants[2]*(states[0]-leakage_current_E_L)-0.0;
}
...
void objectiveFunction3(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[3]-constants[3]*pow(states[2], 3.0)*states[1]*(states[0]-sodium_channel_E_Na)-0.0;
}
