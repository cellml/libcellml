...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables, double *externalVariables, ExternalVariable externalVariable)
{
    ...
    algebraicVariables[2] = states[0]*pow(states[3], 4.0)*potassium_channel_g_K-pow(states[3], 4.0)*potassium_channel_g_K*computedConstants[2];
    rates[0] = (-algebraicVariables[2]-algebraicVariables[1]-externalVariables[0]+algebraicVariables[0])/constants[0];
    algebraicVariables[4] = 4.0*exp(0.0555555555555556*states[0]);
    rates[2] = (1.0-states[2])*algebraicVariables[3]-states[2]*algebraicVariables[4];
    algebraicVariables[6] = 1.0/(1.0+exp(3.0+0.1*states[0]));
    algebraicVariables[5] = 0.07*exp(0.05*states[0]);
    rates[1] = (1.0-states[1])*algebraicVariables[5]-states[1]*algebraicVariables[6];
    ...
    rates[3] = (1.0-states[3])*algebraicVariables[7]-states[3]*algebraicVariables[8];
}
