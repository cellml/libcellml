...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraic_variables[2] = constants[4]*pow(states[2], 4.0)*(states[0]-computed_constants[2])
    ...
    algebraic_variables[3] = constants[3]*pow(external_variables[0], 3.0)*states[1]*(states[0]-computed_constants[1])
    ...
    rates[2] = algebraic_variables[8]*(1.0-states[2])-algebraic_variables[9]*states[2]
