...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables):
    ...
    algebraic_variables[3] = -states[1]*pow(states[2], 3.0)*sodium_channel_g_Na*computed_constants[1]+states[0]*states[1]*pow(states[2], 3.0)*sodium_channel_g_Na
    rates[0] = (-algebraic_variables[3]-algebraic_variables[2]-algebraic_variables[1]+algebraic_variables[0])/membrane_Cm
