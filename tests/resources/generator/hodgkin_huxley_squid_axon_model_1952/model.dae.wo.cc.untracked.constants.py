...
def objective_function_2(u, f, data):
    ...
    f[0] = algebraic[1]-leakage_current_g_L*(states[0]-computed_constants[0])-0.0
...
def objective_function_3(u, f, data):
    ...
    f[0] = algebraic[3]-sodium_channel_g_Na*pow(states[2], 3.0)*states[1]*(states[0]-computed_constants[1])-0.0
...
def objective_function_10(u, f, data):
    ...
    f[0] = algebraic[2]-potassium_channel_g_K*pow(states[3], 4.0)*(states[0]-computed_constants[2])-0.0
