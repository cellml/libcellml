...
#include "model.variant.untracked.control.with.externals.h"
...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables, double *externalVariables, ExternalVariable externalVariable)
{
    ...
    algebraicVariables[1] = states[0]*constants[2]-constants[2]*computedConstants[0];
    algebraicVariables[2] = states[0]*pow(states[3], 4.0)*constants[4]-pow(states[3], 4.0)*constants[4]*computedConstants[2];
