...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    double sodium_channel_i_Na = -states[1]*pow(states[2], 3.0)*sodium_channel_g_Na*sodium_channel_E_Na+states[0]*states[1]*pow(states[2], 3.0)*sodium_channel_g_Na;
    rates[0] = (-sodium_channel_i_Na-potassium_channel_i_K-leakage_current_i_L+membrane_i_Stim)/membrane_Cm;
