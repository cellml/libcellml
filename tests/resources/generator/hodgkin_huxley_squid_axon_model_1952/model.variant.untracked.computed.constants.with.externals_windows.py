...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraic_variables[2] = states[0]*pow(states[3], 4.0)*constants[4]-pow(states[3], 4.0)*constants[4]*computed_constants[0]
    rates[0] = (-algebraic_variables[2]-algebraic_variables[1]-external_variables[0]+algebraic_variables[0])/constants[0]
    algebraic_variables[4] = 4.0*exp(0.0555555555555556*states[0])
    rates[2] = (1.0-states[2])*algebraic_variables[3]-states[2]*algebraic_variables[4]
    algebraic_variables[6] = 1.0/(1.0+exp(3.0+0.1*states[0]))
    algebraic_variables[5] = 0.07*exp(0.05*states[0])
    rates[1] = (1.0-states[1])*algebraic_variables[5]-states[1]*algebraic_variables[6]
    ...
    rates[3] = (1.0-states[3])*algebraic_variables[7]-states[3]*algebraic_variables[8]
