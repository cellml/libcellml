...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    algebraic_variables[2] = -pow(states[3], 4.0)*constants[4]*computed_constants[2]+states[0]*pow(states[3], 4.0)*constants[4]
    ...
    algebraic_variables[1] = states[0]*constants[2]-constants[2]*computed_constants[0]
