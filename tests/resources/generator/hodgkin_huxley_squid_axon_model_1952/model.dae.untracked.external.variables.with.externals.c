...
#include "model.dae.untracked.external.variables.with.externals.h"
...
void objectiveFunction3(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[1]-constants[2]*(membrane_V-algebraic[3])-0.0;
}
...
void objectiveFunction6(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[5]-0.1*(membrane_V+25.0)/(exp((membrane_V+25.0)/10.0)-1.0)-0.0;
}
...
void objectiveFunction7(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[6]-4.0*exp(membrane_V/18.0)-0.0;
}
...
void objectiveFunction9(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[7]-0.07*exp(membrane_V/20.0)-0.0;
}
...
void objectiveFunction10(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[8]-1.0/(exp((membrane_V+30.0)/10.0)+1.0)-0.0;
}
...
void objectiveFunction13(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[2]-constants[4]*pow(states[2], 4.0)*(membrane_V-algebraic[9])-0.0;
}
...
void objectiveFunction15(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[10]-0.125*exp(membrane_V/80.0)-0.0;
}
...
void objectiveFunction16(double *u, double *f, void *data)
{
    ...
    f[0] = rates[2]-(potassium_channel_n_gate_alpha_n*(1.0-states[2])-algebraic[10]*states[2])-0.0;
}
