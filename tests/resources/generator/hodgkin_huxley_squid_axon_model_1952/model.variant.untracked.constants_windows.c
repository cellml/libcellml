...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    algebraicVariables[3] = -states[1]*pow(states[2], 3.0)*sodium_channel_g_Na*computedConstants[1]+states[0]*states[1]*pow(states[2], 3.0)*sodium_channel_g_Na;
    rates[0] = (-algebraicVariables[3]-algebraicVariables[2]-algebraicVariables[1]+algebraicVariables[0])/membrane_Cm;
