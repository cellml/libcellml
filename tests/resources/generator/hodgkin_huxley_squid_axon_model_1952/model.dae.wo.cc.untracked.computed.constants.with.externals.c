...
#include "model.dae.wo.cc.untracked.computed.constants.with.externals.h"
...
void objectiveFunction2(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[1]-constants[2]*(externals[0]-leakage_current_E_L)-0.0;
}
...
void objectiveFunction10(double *u, double *f, void *data)
{
    ...
    f[0] = algebraic[2]-constants[4]*pow(states[2], 4.0)*(externals[0]-potassium_channel_E_K)-0.0;
}
