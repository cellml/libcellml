...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables, external_variables, external_variable):
    ...
    algebraic_variables[2] = -pow(states[3], 4.0)*potassium_channel_g_K*computed_constants[2]+states[0]*pow(states[3], 4.0)*potassium_channel_g_K
    leakage_current_g_L = 0.3
    algebraic_variables[1] = states[0]*leakage_current_g_L-leakage_current_g_L*computed_constants[0]
