...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic, external_variable):
    ...
    external[11] = external_variable(voi, states, rates, variables, 11)
    external[4] = external_variable(voi, states, rates, variables, 4)
    algebraic[5] = external[4]-10.613
    algebraic[1] = constants[1]*(states[0]-algebraic[5])
    algebraic[2] = constants[3]*pow(states[3], 4.0)*(states[0]-external[11])
    algebraic[6] = external[4]-115.0
