...
void computeComputedConstants(double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    computedConstants[1] = 26.6-1.4*computedConstants[0];
    computedConstants[2] = 28.5-0.5*computedConstants[1]-1.5*computedConstants[0];
    computedConstants[3] = computedConstants[2]+computedConstants[1];
}
