...
def compute_computed_constants(constants, computed_constants, algebraic_variables):
    computed_constants[3] = 3.0*constants[1]+constants[0]
    computed_constants[0] = 26.6-1.4*computed_constants[3]
    computed_constants[1] = 28.5-0.5*computed_constants[0]-1.5*computed_constants[3]
    computed_constants[2] = computed_constants[1]+computed_constants[0]
