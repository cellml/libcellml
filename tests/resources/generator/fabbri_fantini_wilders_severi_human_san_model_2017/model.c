...
{
    variables[1] = (variables[127] > 0.0)?1.2:1.0;
    variables[3] = variables[128]/(variables[146]+variables[128]);
    variables[10] = (variables[127] > 0.0)?-0.25:(variables[126] > 0.0)?0.7*variables[126]/(0.00009+variables[126]):0.0;
    ...
    variables[33] = (variables[126] > 0.0)?-1.0-9.898*pow(1.0*variables[126], 0.618)/(pow(1.0*variables[126], 0.618)+0.00122423):0.0;
    variables[34] = (variables[127] > 0.0)?7.5:0.0;
    variables[36] = (variables[127] > 0.0)?1.23:1.0;
    variables[37] = 0.31*variables[126]/(variables[126]+0.00009);
    variables[38] = (variables[127] > 0.0)?-8.0:0.0;
    variables[39] = (variables[127] > 0.0)?-27.0:0.0;
    variables[42] = (variables[127] > 0.0)?1.2*variables[214]:variables[214];
    variables[44] = (variables[127] > 0.0)?-14.0:0.0;
...
void computeRates(double voi, double *states, double *rates, double *variables)
{
    ...
    variables[27] = ((voi > variables[191]) && (voi < variables[191]+variables[192]))?variables[190]:variables[193];
    variables[49] = (variables[189] >= 1.0)?variables[27]:states[31];
    variables[54] = (variables[49] < -(80.0-variables[33]-variables[34]-variables[198]))?0.01329+0.99921/(1.0+exp((variables[49]+97.134-variables[33]-variables[34]-variables[198])/8.1752)):0.0002501*exp(-(variables[49]-variables[33]-variables[34]-variables[198])/12.861);
    ...
    variables[60] = (fabs(variables[59]) < variables[201])?2000.0:200.0*variables[59]/(1.0-exp(-0.1*variables[59]));
    ...
    variables[77] = (variables[49] == -41.8)?-41.80001:(variables[49] == 0.0)?0.0:(variables[49] == -6.8)?-6.80001:variables[49];
    ...
    variables[78] = (variables[49] == -1.8)?-1.80001:variables[49];
    ...
    variables[103] = (variables[126] > 0.0)?variables[215]*variables[216]*(variables[49]-variables[47])*(1.0+exp((variables[49]+20.0)/20.0))*states[25]:0.0;
