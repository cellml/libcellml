...
void computeComputedConstants(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    computedConstants[16] = (constants[0] > 0.0)?-1.0-9.898*pow(constants[0], 0.618)/(pow(constants[0], 0.618)+0.00122423):0.0;
    ...
    computedConstants[24] = 3.573159/(1.0+0.0000012155/pow(constants[0], 1.6951))+0.025641;
}
...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    algebraicVariables[4] = computedConstants[4]*constants[10]*1.0/(1.0+exp((-algebraicVariables[8]+algebraicVariables[1]-110.0)/20.0))/(1.0+pow(constants[8]/algebraicVariables[0], 1.3))/(1.0+pow(constants[9]/constants[4], 1.2));
    algebraicVariables[5] = 0.0000185*constants[77]*algebraicVariables[8]/(computedConstants[0]*(1.0-exp(-algebraicVariables[8]/computedConstants[0])))*(algebraicVariables[0]-constants[2]*exp(-algebraicVariables[8]/computedConstants[0]))*states[23]*states[22]*states[21];
    ...
    rates[1] = (1.0-constants[7])*(-algebraicVariables[7]-algebraicVariables[6]-algebraicVariables[5]-3.0*algebraicVariables[4]-3.0*algebraicVariables[3])/((computedConstants[3]+computedConstants[2])*constants[6]);
    ...
    rates[7] = (algebraicVariables[28]*computedConstants[2]-algebraicVariables[29]*computedConstants[8])/computedConstants[3]-(constants[52]*algebraicVariables[34]+constants[50]*algebraicVariables[31]+constants[51]*algebraicVariables[32]);
    algebraicVariables[37] = 2.0*constants[84]*algebraicVariables[8]/(computedConstants[0]*(1.0-exp(-algebraicVariables[8]*2.0/computedConstants[0])))*(states[0]-constants[5]*exp(-2.0*algebraicVariables[8]/computedConstants[0]))*states[25]*states[24];
    algebraicVariables[38] = 2.0*constants[77]*algebraicVariables[8]/(computedConstants[0]*(1.0-exp(-algebraicVariables[8]*2.0/computedConstants[0])))*(states[0]-constants[5]*exp(-2.0*algebraicVariables[8]/computedConstants[0]))*states[23]*states[22]*states[21];
    ...
    algebraicVariables[41] = (algebraicVariables[38]+algebraicVariables[67]+algebraicVariables[5])*(1.0-computedConstants[19])*computedConstants[18];
    ...
    algebraicVariables[95] = exp((-algebraicVariables[8]+computedConstants[23]+5.0)/25.0);
