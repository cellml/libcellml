...
STATE_VECTOR_INFORMATION_ARRAY = [
    ...
    {"name": "I", "units": "dimensionless"},
    {"name": "RI", "units": "dimensionless"},
    {"name": "Ca_jsr", "units": "millimolar"},
    {"name": "fCa", "units": "dimensionless"},
    {"name": "fTC", "units": "dimensionless"},
    {"name": "fTMC", "units": "dimensionless"},
    {"name": "fTMM", "units": "dimensionless"},
    {"name": "fCMi", "units": "dimensionless"},
    {"name": "fCMs", "units": "dimensionless"},
    {"name": "fCQ", "units": "dimensionless"},
    {"name": "Cai", "units": "millimolar"},
    {"name": "Ca_nsr", "units": "millimolar"},
    {"name": "y", "units": "dimensionless"},
    {"name": "m", "units": "dimensionless"},
    {"name": "h", "units": "dimensionless"},
    {"name": "fL", "units": "dimensionless"},
    {"name": "dT", "units": "dimensionless"},
    {"name": "fT", "units": "dimensionless"},
    {"name": "q", "units": "dimensionless"},
    {"name": "r", "units": "dimensionless"},
    {"name": "paS", "units": "dimensionless"},
    {"name": "paF", "units": "dimensionless"},
    {"name": "piy", "units": "dimensionless"},
    {"name": "a", "units": "dimensionless"},
    {"name": "r_Kur", "units": "dimensionless"},
    {"name": "s_Kur", "units": "dimensionless"},
    {"name": "n", "units": "dimensionless"},
    {"name": "dL", "units": "dimensionless"},
    {"name": "Ca_sub", "units": "millimolar"},
    {"name": "V_ode", "units": "millivolt"},
    {"name": "Nai_", "units": "millimolar"},
]

VARIABLE_VECTOR_INFORMATION_ARRAY = [
    {"name": "EC50_SR", "units": "millimolar"},
    {"name": "HSR", "units": "dimensionless"},
    {"name": "MaxSR", "units": "dimensionless"},
    {"name": "MinSR", "units": "dimensionless"},
    {"name": "kiCa", "units": "per_millimolar_second"},
    {"name": "kim", "units": "per_second"},
    {"name": "koCa", "units": "per_millimolar2_second"},
    {"name": "kom", "units": "per_second"},
    {"name": "ks", "units": "per_second"},
    {"name": "CM_tot", "units": "millimolar"},
    {"name": "CQ_tot", "units": "millimolar"},
    {"name": "Mgi", "units": "millimolar"},
    {"name": "TC_tot", "units": "millimolar"},
    {"name": "TMC_tot", "units": "millimolar"},
    {"name": "kb_CM", "units": "per_second"},
    {"name": "kb_CQ", "units": "per_second"},
    {"name": "kb_TC", "units": "per_second"},
    {"name": "kb_TMC", "units": "per_second"},
    {"name": "kb_TMM", "units": "per_second"},
    ...
    {"name": "P_up_basal", "units": "millimolar_per_second"},
    {"name": "slope_up", "units": "millimolar"},
    {"name": "tau_dif_Ca", "units": "second"},
    {"name": "tau_tr", "units": "second"},
    {"name": "L_cell", "units": "micrometre"},
    {"name": "L_sub", "units": "micrometre"},
    {"name": "R_cell", "units": "micrometre"},
    {"name": "V_i_part", "units": "dimensionless"},
    {"name": "V_jsr_part", "units": "dimensionless"},
    {"name": "V_nsr_part", "units": "dimensionless"},
    ...
    {"name": "R", "units": "joule_per_kilomole_kelvin"},
    {"name": "T", "units": "kelvin"},
    {"name": "clamp_mode", "units": "dimensionless"},
    {"name": "Nai_clamp", "units": "dimensionless"},
    {"name": "ACh", "units": "millimolar"},
    {"name": "Iso_1_uM", "units": "dimensionless"},
    {"name": "V_holding", "units": "millivolt"},
    {"name": "V_test", "units": "millivolt"},
    {"name": "t_holding", "units": "second"},
    {"name": "t_test", "units": "second"},
    {"name": "P_CaL", "units": "nanoA_per_millimolar"},
    {"name": "V_dL", "units": "millivolt"},
    {"name": "k_dL", "units": "millivolt"},
    {"name": "Km_fCa", "units": "millimolar"},
    {"name": "alpha_fCa", "units": "per_second"},
    {"name": "k_fL", "units": "millivolt"},
    {"name": "shift_fL", "units": "millivolt"},
    {"name": "P_CaT", "units": "nanoA_per_millimolar"},
    {"name": "offset_fT", "units": "second"},
    {"name": "ACh_on", "units": "dimensionless"},
    {"name": "g_KACh", "units": "microS"},
    {"name": "g_Kr", "units": "microS"},
    {"name": "g_Ks_", "units": "microS"},
    {"name": "g_Kur", "units": "microS"},
    {"name": "g_Na", "units": "microS"},
    {"name": "g_Na_L", "units": "microS"},
    {"name": "K1ni", "units": "millimolar"},
    {"name": "K1no", "units": "millimolar"},
    ...
    {"name": "Qci", "units": "dimensionless"},
    {"name": "Qco", "units": "dimensionless"},
    {"name": "Qn", "units": "dimensionless"},
    {"name": "blockade_NaCa", "units": "dimensionless"},
    {"name": "Km_Kp", "units": "millimolar"},
    {"name": "Km_Nap", "units": "millimolar"},
    {"name": "i_NaK_max", "units": "nanoA"},
    {"name": "delta_m", "units": "millivolt"},
    {"name": "Km_f", "units": "millimolar"},
    {"name": "alpha", "units": "dimensionless"},
    {"name": "blockade", "units": "dimensionless"},
    {"name": "g_f", "units": "microS"},
    {"name": "y_shift", "units": "millivolt"},
    {"name": "g_to", "units": "microS"},
    {"name": "Iso_increase", "units": "dimensionless"},
    {"name": "k34", "units": "dimensionless"},
    {"name": "b_up", "units": "dimensionless"},
    {"name": "P_up", "units": "millimolar_per_second"},
    {"name": "V_cell", "units": "millimetre3"},
    {"name": "V_sub", "units": "millimetre3"},
    {"name": "V_jsr", "units": "millimetre3"},
    {"name": "V_i", "units": "millimetre3"},
    {"name": "V_nsr", "units": "millimetre3"},
    {"name": "RTONF", "units": "millivolt"},
    {"name": "G_f", "units": "microS"},
    {"name": "G_f_K", "units": "microS"},
    {"name": "G_f_Na", "units": "microS"},
    {"name": "g_f_Na", "units": "microS"},
    {"name": "g_f_K", "units": "microS"},
    {"name": "ACh_shift", "units": "millivolt"},
    {"name": "Iso_shift", "units": "millivolt"},
    {"name": "Iso_increase", "units": "dimensionless"},
    {"name": "ACh_block", "units": "dimensionless"},
    {"name": "Iso_shift_dL", "units": "millivolt"},
    {"name": "Iso_slope_dL", "units": "dimensionless"},
    {"name": "g_Ks", "units": "microS"},
    {"name": "Iso_shift", "units": "millivolt"},
    {"name": "alpha_a", "units": "per_second"},
    {"name": "E_K", "units": "millivolt"},
    {"name": "Nai", "units": "millimolar"},
    {"name": "k43", "units": "dimensionless"},
    {"name": "j_SRCarel", "units": "millimolar_per_second"},
    {"name": "diff", "units": "millimolar"},
    {"name": "kCaSR", "units": "dimensionless"},
    {"name": "koSRCa", "units": "per_millimolar2_second"},
    {"name": "kiSRCa", "units": "per_millimolar_second"},
    {"name": "P_tot", "units": "dimensionless"},
    {"name": "j_Ca_dif", "units": "millimolar_per_second"},
    {"name": "j_up", "units": "millimolar_per_second"},
    {"name": "j_tr", "units": "millimolar_per_second"},
    {"name": "delta_fTC", "units": "per_second"},
    {"name": "delta_fTMC", "units": "per_second"},
    {"name": "delta_fTMM", "units": "per_second"},
    {"name": "delta_fCMi", "units": "per_second"},
    {"name": "delta_fCMs", "units": "per_second"},
    {"name": "delta_fCQ", "units": "per_second"},
    {"name": "V_clamp", "units": "millivolt"},
    {"name": "E_mh", "units": "millivolt"},
    {"name": "fCa_infinity", "units": "dimensionless"},
    {"name": "tau_fCa", "units": "second"},
    {"name": "E_Ks", "units": "millivolt"},
    {"name": "E_Na", "units": "millivolt"},
    {"name": "E_Ca", "units": "millivolt"},
    {"name": "V", "units": "millivolt"},
    {"name": "i_fNa", "units": "nanoA"},
    {"name": "i_fK", "units": "nanoA"},
    {"name": "i_f", "units": "nanoA"},
    {"name": "tau_y", "units": "second"},
    {"name": "y_infinity", "units": "dimensionless"},
    {"name": "i_Na_", "units": "nanoA"},
    {"name": "i_Na_L", "units": "nanoA"},
    {"name": "i_Na", "units": "nanoA"},
    {"name": "m_infinity", "units": "dimensionless"},
    {"name": "E0_m", "units": "millivolt"},
    {"name": "alpha_m", "units": "per_second"},
    {"name": "beta_m", "units": "per_second"},
    {"name": "tau_m", "units": "second"},
    {"name": "h_infinity", "units": "dimensionless"},
    {"name": "alpha_h", "units": "per_second"},
    {"name": "beta_h", "units": "per_second"},
    {"name": "tau_h", "units": "second"},
    {"name": "i_Kur", "units": "nanoA"},
    {"name": "r_Kur_infinity", "units": "dimensionless"},
    {"name": "tau_r_Kur", "units": "second"},
    {"name": "s_Kur_infinity", "units": "dimensionless"},
    {"name": "tau_s_Kur", "units": "second"},
    {"name": "i_siCa", "units": "nanoA"},
    {"name": "i_siK", "units": "nanoA"},
    {"name": "i_siNa", "units": "nanoA"},
    {"name": "i_CaL", "units": "nanoA"},
    {"name": "dL_infinity", "units": "dimensionless"},
    {"name": "adVm", "units": "millivolt"},
    {"name": "bdVm", "units": "millivolt"},
    {"name": "fL_infinity", "units": "dimensionless"},
    {"name": "tau_fL", "units": "second"},
    {"name": "i_CaT", "units": "nanoA"},
    {"name": "dT_infinity", "units": "dimensionless"},
    {"name": "tau_dT", "units": "second"},
    {"name": "fT_infinity", "units": "dimensionless"},
    {"name": "tau_fT", "units": "second"},
    ...
    {"name": "i_Kr", "units": "nanoA"},
    {"name": "alfapaF", "units": "per_second"},
    {"name": "betapaF", "units": "per_second"},
    {"name": "pa_infinity", "units": "dimensionless"},
    {"name": "tau_paS", "units": "second"},
    {"name": "tau_paF", "units": "second"},
    {"name": "tau_pi", "units": "second"},
    {"name": "pi_infinity", "units": "dimensionless"},
    {"name": "i_Ks", "units": "nanoA"},
    {"name": "n_infinity", "units": "dimensionless"},
    {"name": "alpha_n", "units": "per_second"},
    {"name": "beta_n", "units": "per_second"},
    {"name": "i_KACh", "units": "nanoA"},
    {"name": "beta_a", "units": "per_second"},
    {"name": "a_infinity", "units": "dimensionless"},
    {"name": "tau_a", "units": "second"},
    {"name": "i_NaK", "units": "nanoA"},
    {"name": "k41", "units": "dimensionless"},
    {"name": "di", "units": "dimensionless"},
    {"name": "k32", "units": "dimensionless"},
    {"name": "do", "units": "dimensionless"},
    {"name": "alpha_dL", "units": "per_second"},
    {"name": "beta_dL", "units": "per_second"},
    {"name": "tau_n", "units": "second"},
    {"name": "k12", "units": "dimensionless"},
    {"name": "k14", "units": "dimensionless"},
    {"name": "k21", "units": "dimensionless"},
    {"name": "k23", "units": "dimensionless"},
    {"name": "tau_dL", "units": "second"},
    {"name": "x1", "units": "dimensionless"},
    {"name": "x2", "units": "dimensionless"},
    {"name": "x3", "units": "dimensionless"},
    {"name": "x4", "units": "dimensionless"},
    {"name": "i_NaCa", "units": "nanoA"},
    {"name": "i_tot", "units": "nanoA"},
]
