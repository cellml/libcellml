...
STATE_INFO = [
    ...
    {"component": "Ca_SR_release", "name": "RI", "units": "dimensionless"},
    {"component": "Ca_dynamics", "name": "Ca_jsr", "units": "millimolar"},
    {"component": "i_CaL_fCa_gate", "name": "fCa", "units": "dimensionless"},
    {"component": "Ca_buffering", "name": "fTC", "units": "dimensionless"},
    {"component": "Ca_buffering", "name": "fTMC", "units": "dimensionless"},
    {"component": "Ca_buffering", "name": "fTMM", "units": "dimensionless"},
    {"component": "Ca_buffering", "name": "fCMi", "units": "dimensionless"},
    {"component": "Ca_buffering", "name": "fCMs", "units": "dimensionless"},
    {"component": "Ca_buffering", "name": "fCQ", "units": "dimensionless"},
    {"component": "Ca_dynamics", "name": "Cai", "units": "millimolar"},
    {"component": "Ca_dynamics", "name": "Ca_nsr", "units": "millimolar"},
    {"component": "i_f_y_gate", "name": "y", "units": "dimensionless"},
    {"component": "i_Na_m_gate", "name": "m", "units": "dimensionless"},
    {"component": "i_Na_h_gate", "name": "h", "units": "dimensionless"},
    {"component": "i_CaL_fL_gate", "name": "fL", "units": "dimensionless"},
    {"component": "i_CaT_dT_gate", "name": "dT", "units": "dimensionless"},
    {"component": "i_CaT_fT_gate", "name": "fT", "units": "dimensionless"},
    {"component": "i_to_q_gate", "name": "q", "units": "dimensionless"},
    {"component": "i_to_r_gate", "name": "r", "units": "dimensionless"},
    {"component": "i_Kr_pa_gate", "name": "paS", "units": "dimensionless"},
    {"component": "i_Kr_pa_gate", "name": "paF", "units": "dimensionless"},
    {"component": "i_Kr_pi_gate", "name": "piy", "units": "dimensionless"},
    {"component": "i_KACh_a_gate", "name": "a", "units": "dimensionless"},
    {"component": "i_Kur_rKur_gate", "name": "r_Kur", "units": "dimensionless"},
    {"component": "i_Kur_sKur_gate", "name": "s_Kur", "units": "dimensionless"},
    {"component": "i_Ks_n_gate", "name": "n", "units": "dimensionless"},
...
VARIABLE_INFO = [
    ...
    {"component": "Ca_SR_release", "name": "MinSR", "units": "dimensionless"},
    {"component": "Ca_SR_release", "name": "kiCa", "units": "per_millimolar_second"},
    {"component": "Ca_SR_release", "name": "kim", "units": "per_second"},
    {"component": "Ca_SR_release", "name": "koCa", "units": "per_millimolar2_second"},
    {"component": "Ca_SR_release", "name": "kom", "units": "per_second"},
    {"component": "Ca_SR_release", "name": "ks", "units": "per_second"},
    ...
    {"component": "Ca_buffering", "name": "TC_tot", "units": "millimolar"},
    {"component": "Ca_buffering", "name": "TMC_tot", "units": "millimolar"},
    {"component": "Ca_buffering", "name": "kb_CM", "units": "per_second"},
    {"component": "Ca_buffering", "name": "kb_CQ", "units": "per_second"},
    {"component": "Ca_buffering", "name": "kb_TC", "units": "per_second"},
    {"component": "Ca_buffering", "name": "kb_TMC", "units": "per_second"},
    {"component": "Ca_buffering", "name": "kb_TMM", "units": "per_second"},
    {"component": "Ca_buffering", "name": "kf_CM", "units": "per_millimolar_second"},
    {"component": "Ca_buffering", "name": "kf_CQ", "units": "per_millimolar_second"},
    ...
    {"component": "Ca_intracellular_fluxes", "name": "P_up_basal", "units": "millimolar_per_second"},
    {"component": "Ca_intracellular_fluxes", "name": "slope_up", "units": "millimolar"},
    {"component": "Ca_intracellular_fluxes", "name": "tau_dif_Ca", "units": "second"},
    {"component": "Ca_intracellular_fluxes", "name": "tau_tr", "units": "second"},
    {"component": "Cell_parameters", "name": "L_cell", "units": "micrometre"},
    {"component": "Cell_parameters", "name": "L_sub", "units": "micrometre"},
    {"component": "Cell_parameters", "name": "R_cell", "units": "micrometre"},
    {"component": "Cell_parameters", "name": "V_i_part", "units": "dimensionless"},
    {"component": "Cell_parameters", "name": "V_jsr_part", "units": "dimensionless"},
    {"component": "Cell_parameters", "name": "V_nsr_part", "units": "dimensionless"},
    ...
    {"component": "Ionic_values", "name": "Nao", "units": "millimolar"},
    {"component": "Membrane", "name": "C", "units": "microF"},
    {"component": "Membrane", "name": "F", "units": "coulomb_per_mole"},
    {"component": "Membrane", "name": "R", "units": "joule_per_kilomole_kelvin"},
    {"component": "Membrane", "name": "T", "units": "kelvin"},
    {"component": "Membrane", "name": "clamp_mode", "units": "dimensionless"},
    {"component": "Nai_concentration", "name": "Nai_clamp", "units": "dimensionless"},
    {"component": "Rate_modulation_experiments", "name": "ACh", "units": "millimolar"},
    {"component": "Rate_modulation_experiments", "name": "Iso_1_uM", "units": "dimensionless"},
    {"component": "Voltage_clamp", "name": "V_holding", "units": "millivolt"},
    {"component": "Voltage_clamp", "name": "V_test", "units": "millivolt"},
    {"component": "Voltage_clamp", "name": "t_holding", "units": "second"},
    {"component": "Voltage_clamp", "name": "t_test", "units": "second"},
    {"component": "i_CaL", "name": "P_CaL", "units": "nanoA_per_millimolar"},
    {"component": "i_CaL_dL_gate", "name": "V_dL", "units": "millivolt"},
    {"component": "i_CaL_dL_gate", "name": "k_dL", "units": "millivolt"},
    {"component": "i_CaL_fCa_gate", "name": "Km_fCa", "units": "millimolar"},
    {"component": "i_CaL_fCa_gate", "name": "alpha_fCa", "units": "per_second"},
    {"component": "i_CaL_fL_gate", "name": "k_fL", "units": "millivolt"},
    {"component": "i_CaL_fL_gate", "name": "shift_fL", "units": "millivolt"},
    {"component": "i_CaT", "name": "P_CaT", "units": "nanoA_per_millimolar"},
    {"component": "i_CaT_fT_gate", "name": "offset_fT", "units": "second"},
    {"component": "i_KACh", "name": "ACh_on", "units": "dimensionless"},
    {"component": "i_KACh", "name": "g_KACh", "units": "microS"},
    {"component": "i_Kr", "name": "g_Kr", "units": "microS"},
    {"component": "i_Ks", "name": "g_Ks_", "units": "microS"},
    {"component": "i_Kur", "name": "g_Kur", "units": "microS"},
    {"component": "i_Na", "name": "g_Na", "units": "microS"},
    {"component": "i_Na", "name": "g_Na_L", "units": "microS"},
    {"component": "i_NaCa", "name": "K1ni", "units": "millimolar"},
    {"component": "i_NaCa", "name": "K1no", "units": "millimolar"},
    {"component": "i_NaCa", "name": "K2ni", "units": "millimolar"},
    {"component": "i_NaCa", "name": "K2no", "units": "millimolar"},
    {"component": "i_NaCa", "name": "K3ni", "units": "millimolar"},
    {"component": "i_NaCa", "name": "K3no", "units": "millimolar"},
    {"component": "i_NaCa", "name": "K_NaCa", "units": "nanoA"},
    ...
    {"component": "i_NaCa", "name": "Qci", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "Qco", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "Qn", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "blockade_NaCa", "units": "dimensionless"},
    {"component": "i_NaK", "name": "Km_Kp", "units": "millimolar"},
    {"component": "i_NaK", "name": "Km_Nap", "units": "millimolar"},
    {"component": "i_NaK", "name": "i_NaK_max", "units": "nanoA"},
    {"component": "i_Na_m_gate", "name": "delta_m", "units": "millivolt"},
    {"component": "i_f", "name": "Km_f", "units": "millimolar"},
    {"component": "i_f", "name": "alpha", "units": "dimensionless"},
    {"component": "i_f", "name": "blockade", "units": "dimensionless"},
    {"component": "i_f", "name": "g_f", "units": "microS"},
    {"component": "i_f_y_gate", "name": "y_shift", "units": "millivolt"},
    {"component": "i_to", "name": "g_to", "units": "microS"},
    {"component": "i_NaK", "name": "Iso_increase", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "k34", "units": "dimensionless"},
    {"component": "Ca_intracellular_fluxes", "name": "b_up", "units": "dimensionless"},
    {"component": "Ca_intracellular_fluxes", "name": "P_up", "units": "millimolar_per_second"},
    {"component": "Cell_parameters", "name": "V_cell", "units": "millimetre3"},
    {"component": "Nai_concentration", "name": "V_sub", "units": "millimetre3"},
    {"component": "Ca_dynamics", "name": "V_jsr", "units": "millimetre3"},
    {"component": "Nai_concentration", "name": "V_i", "units": "millimetre3"},
    {"component": "Ca_dynamics", "name": "V_nsr", "units": "millimetre3"},
    {"component": "Ionic_values", "name": "RTONF", "units": "millivolt"},
    {"component": "i_f", "name": "G_f", "units": "microS"},
    {"component": "i_f", "name": "G_f_K", "units": "microS"},
    {"component": "i_f", "name": "G_f_Na", "units": "microS"},
    {"component": "i_f", "name": "g_f_Na", "units": "microS"},
    {"component": "i_f", "name": "g_f_K", "units": "microS"},
    {"component": "i_f_y_gate", "name": "ACh_shift", "units": "millivolt"},
    {"component": "i_f_y_gate", "name": "Iso_shift", "units": "millivolt"},
    {"component": "i_CaL", "name": "Iso_increase", "units": "dimensionless"},
    {"component": "i_CaL", "name": "ACh_block", "units": "dimensionless"},
    {"component": "i_CaL_dL_gate", "name": "Iso_shift_dL", "units": "millivolt"},
    {"component": "i_CaL_dL_gate", "name": "Iso_slope_dL", "units": "dimensionless"},
    {"component": "i_Ks", "name": "g_Ks", "units": "microS"},
    {"component": "i_Ks_n_gate", "name": "Iso_shift", "units": "millivolt"},
    {"component": "i_KACh_a_gate", "name": "alpha_a", "units": "per_second"},
    {"component": "Ionic_values", "name": "E_K", "units": "millivolt"},
    {"component": "Ionic_values", "name": "Nai", "units": "millimolar"},
    {"component": "i_NaCa", "name": "k43", "units": "dimensionless"},
    {"component": "Ca_SR_release", "name": "j_SRCarel", "units": "millimolar_per_second"},
    {"component": "Ca_SR_release", "name": "diff", "units": "millimolar"},
    {"component": "Ca_SR_release", "name": "kCaSR", "units": "dimensionless"},
    {"component": "Ca_SR_release", "name": "koSRCa", "units": "per_millimolar2_second"},
    {"component": "Ca_SR_release", "name": "kiSRCa", "units": "per_millimolar_second"},
    {"component": "Ca_SR_release", "name": "P_tot", "units": "dimensionless"},
    {"component": "Ca_intracellular_fluxes", "name": "j_Ca_dif", "units": "millimolar_per_second"},
    {"component": "Ca_intracellular_fluxes", "name": "j_up", "units": "millimolar_per_second"},
    {"component": "Ca_intracellular_fluxes", "name": "j_tr", "units": "millimolar_per_second"},
    {"component": "Ca_buffering", "name": "delta_fTC", "units": "per_second"},
    {"component": "Ca_buffering", "name": "delta_fTMC", "units": "per_second"},
    {"component": "Ca_buffering", "name": "delta_fTMM", "units": "per_second"},
    {"component": "Ca_buffering", "name": "delta_fCMi", "units": "per_second"},
    {"component": "Ca_buffering", "name": "delta_fCMs", "units": "per_second"},
    {"component": "Ca_buffering", "name": "delta_fCQ", "units": "per_second"},
    {"component": "Membrane", "name": "V_clamp", "units": "millivolt"},
    {"component": "i_Na", "name": "E_mh", "units": "millivolt"},
    {"component": "i_CaL_fCa_gate", "name": "fCa_infinity", "units": "dimensionless"},
    {"component": "i_CaL_fCa_gate", "name": "tau_fCa", "units": "second"},
    {"component": "i_Ks", "name": "E_Ks", "units": "millivolt"},
    {"component": "Ionic_values", "name": "E_Na", "units": "millivolt"},
    {"component": "Ionic_values", "name": "E_Ca", "units": "millivolt"},
    {"component": "i_NaK", "name": "V", "units": "millivolt"},
    {"component": "Nai_concentration", "name": "i_fNa", "units": "nanoA"},
    {"component": "i_f", "name": "i_fK", "units": "nanoA"},
    {"component": "Membrane", "name": "i_f", "units": "nanoA"},
    {"component": "i_f_y_gate", "name": "tau_y", "units": "second"},
    {"component": "i_f_y_gate", "name": "y_infinity", "units": "dimensionless"},
    {"component": "i_Na", "name": "i_Na_", "units": "nanoA"},
    {"component": "i_Na", "name": "i_Na_L", "units": "nanoA"},
    {"component": "Nai_concentration", "name": "i_Na", "units": "nanoA"},
    {"component": "i_Na_m_gate", "name": "m_infinity", "units": "dimensionless"},
    {"component": "i_Na_m_gate", "name": "E0_m", "units": "millivolt"},
    {"component": "i_Na_m_gate", "name": "alpha_m", "units": "per_second"},
    {"component": "i_Na_m_gate", "name": "beta_m", "units": "per_second"},
    {"component": "i_Na_m_gate", "name": "tau_m", "units": "second"},
    {"component": "i_Na_h_gate", "name": "h_infinity", "units": "dimensionless"},
    {"component": "i_Na_h_gate", "name": "alpha_h", "units": "per_second"},
    {"component": "i_Na_h_gate", "name": "beta_h", "units": "per_second"},
    {"component": "i_Na_h_gate", "name": "tau_h", "units": "second"},
    {"component": "Membrane", "name": "i_Kur", "units": "nanoA"},
    {"component": "i_Kur_rKur_gate", "name": "r_Kur_infinity", "units": "dimensionless"},
    {"component": "i_Kur_rKur_gate", "name": "tau_r_Kur", "units": "second"},
    {"component": "i_Kur_sKur_gate", "name": "s_Kur_infinity", "units": "dimensionless"},
    {"component": "i_Kur_sKur_gate", "name": "tau_s_Kur", "units": "second"},
    {"component": "Ca_dynamics", "name": "i_siCa", "units": "nanoA"},
    {"component": "i_CaL", "name": "i_siK", "units": "nanoA"},
    {"component": "Nai_concentration", "name": "i_siNa", "units": "nanoA"},
    {"component": "Membrane", "name": "i_CaL", "units": "nanoA"},
    {"component": "i_CaL_dL_gate", "name": "dL_infinity", "units": "dimensionless"},
    {"component": "i_CaL_dL_gate", "name": "adVm", "units": "millivolt"},
    {"component": "i_CaL_dL_gate", "name": "bdVm", "units": "millivolt"},
    {"component": "i_CaL_fL_gate", "name": "fL_infinity", "units": "dimensionless"},
    {"component": "i_CaL_fL_gate", "name": "tau_fL", "units": "second"},
    {"component": "Ca_dynamics", "name": "i_CaT", "units": "nanoA"},
    {"component": "i_CaT_dT_gate", "name": "dT_infinity", "units": "dimensionless"},
    {"component": "i_CaT_dT_gate", "name": "tau_dT", "units": "second"},
    {"component": "i_CaT_fT_gate", "name": "fT_infinity", "units": "dimensionless"},
    {"component": "i_CaT_fT_gate", "name": "tau_fT", "units": "second"},
    {"component": "Membrane", "name": "i_to", "units": "nanoA"},
    {"component": "i_to_q_gate", "name": "q_infinity", "units": "dimensionless"},
    {"component": "i_to_q_gate", "name": "tau_q", "units": "second"},
    {"component": "i_to_r_gate", "name": "r_infinity", "units": "dimensionless"},
    {"component": "i_to_r_gate", "name": "tau_r", "units": "second"},
    {"component": "Membrane", "name": "i_Kr", "units": "nanoA"},
    {"component": "i_Kr_pa_gate", "name": "alfapaF", "units": "per_second"},
    {"component": "i_Kr_pa_gate", "name": "betapaF", "units": "per_second"},
    {"component": "i_Kr_pa_gate", "name": "pa_infinity", "units": "dimensionless"},
    {"component": "i_Kr_pa_gate", "name": "tau_paS", "units": "second"},
    {"component": "i_Kr_pa_gate", "name": "tau_paF", "units": "second"},
    {"component": "i_Kr_pi_gate", "name": "tau_pi", "units": "second"},
    {"component": "i_Kr_pi_gate", "name": "pi_infinity", "units": "dimensionless"},
    {"component": "Membrane", "name": "i_Ks", "units": "nanoA"},
    {"component": "i_Ks_n_gate", "name": "n_infinity", "units": "dimensionless"},
    {"component": "i_Ks_n_gate", "name": "alpha_n", "units": "per_second"},
    {"component": "i_Ks_n_gate", "name": "beta_n", "units": "per_second"},
    {"component": "Membrane", "name": "i_KACh", "units": "nanoA"},
    {"component": "i_KACh_a_gate", "name": "beta_a", "units": "per_second"},
    {"component": "i_KACh_a_gate", "name": "a_infinity", "units": "dimensionless"},
    {"component": "i_KACh_a_gate", "name": "tau_a", "units": "second"},
    {"component": "Nai_concentration", "name": "i_NaK", "units": "nanoA"},
    {"component": "i_NaCa", "name": "k41", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "di", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "k32", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "do", "units": "dimensionless"},
    {"component": "i_CaL_dL_gate", "name": "alpha_dL", "units": "per_second"},
    {"component": "i_CaL_dL_gate", "name": "beta_dL", "units": "per_second"},
    {"component": "i_Ks_n_gate", "name": "tau_n", "units": "second"},
    {"component": "i_NaCa", "name": "k12", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "k14", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "k21", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "k23", "units": "dimensionless"},
    {"component": "i_CaL_dL_gate", "name": "tau_dL", "units": "second"},
    {"component": "i_NaCa", "name": "x1", "units": "dimensionless"},
    {"component": "i_NaCa", "name": "x2", "units": "dimensionless"},
