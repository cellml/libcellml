...
const struct VARIABLE_INFO VARIABLE_VECTOR_INFORMATION_ARRAY[] = {
    ...
    {"MaxSR", "dimensionless"},
    {"MinSR", "dimensionless"},
    {"kiCa", "per_millimolar_second"},
    {"kim", "per_second"},
    {"koCa", "per_millimolar2_second"},
    {"kom", "per_second"},
    {"ks", "per_second"},
    {"CM_tot", "millimolar"},
    {"CQ_tot", "millimolar"},
    ...
    {"kb_TMC", "per_second"},
    {"kb_TMM", "per_second"},
    {"kf_CM", "per_millimolar_second"},
    {"kf_CQ", "per_millimolar_second"},
    {"kf_TC", "per_millimolar_second"},
    {"kf_TMC", "per_millimolar_second"},
    {"kf_TMM", "per_millimolar_second"},
    {"K_up", "millimolar"},
    {"P_up_basal", "millimolar_per_second"},
    {"slope_up", "millimolar"},
    {"tau_dif_Ca", "second"},
    {"tau_tr", "second"},
    {"L_cell", "micrometre"},
    {"L_sub", "micrometre"},
    {"R_cell", "micrometre"},
    {"V_i_part", "dimensionless"},
    {"V_jsr_part", "dimensionless"},
    {"V_nsr_part", "dimensionless"},
    {"Cao", "millimolar"},
    {"Ki", "millimolar"},
    {"Ko", "millimolar"},
    {"Nao", "millimolar"},
    {"C", "microF"},
    {"F", "coulomb_per_mole"},
    {"R", "joule_per_kilomole_kelvin"},
    {"T", "kelvin"},
    {"clamp_mode", "dimensionless"},
    {"Nai_clamp", "dimensionless"},
    {"ACh", "millimolar"},
    {"Iso_1_uM", "dimensionless"},
    {"V_holding", "millivolt"},
    {"V_test", "millivolt"},
    {"t_holding", "second"},
    {"t_test", "second"},
    {"P_CaL", "nanoA_per_millimolar"},
    {"V_dL", "millivolt"},
    {"k_dL", "millivolt"},
    {"Km_fCa", "millimolar"},
    {"alpha_fCa", "per_second"},
    {"k_fL", "millivolt"},
    {"shift_fL", "millivolt"},
    {"P_CaT", "nanoA_per_millimolar"},
    {"offset_fT", "second"},
    {"ACh_on", "dimensionless"},
    {"g_KACh", "microS"},
    {"g_Kr", "microS"},
    {"g_Ks_", "microS"},
    {"g_Kur", "microS"},
    ...
    {"Km_f", "millimolar"},
    {"alpha", "dimensionless"},
    {"blockade", "dimensionless"},
    {"g_f", "microS"},
    {"y_shift", "millivolt"},
    {"g_to", "microS"},
    {"Iso_increase", "dimensionless"},
    {"k34", "dimensionless"},
    {"b_up", "dimensionless"},
    {"P_up", "millimolar_per_second"},
    {"V_cell", "millimetre3"},
    {"V_sub", "millimetre3"},
    {"V_jsr", "millimetre3"},
    {"V_i", "millimetre3"},
    ...
    {"Iso_shift", "millivolt"},
    {"Iso_increase", "dimensionless"},
    {"ACh_block", "dimensionless"},
    {"Iso_shift_dL", "millivolt"},
    {"Iso_slope_dL", "dimensionless"},
    {"g_Ks", "microS"},
    {"Iso_shift", "millivolt"},
    {"alpha_a", "per_second"},
    {"E_K", "millivolt"},
    {"Nai", "millimolar"},
    {"k43", "dimensionless"},
    {"j_SRCarel", "millimolar_per_second"},
    {"diff", "millimolar"},
    {"kCaSR", "dimensionless"},
    {"koSRCa", "per_millimolar2_second"},
    {"kiSRCa", "per_millimolar_second"},
    {"P_tot", "dimensionless"},
    {"j_Ca_dif", "millimolar_per_second"},
    {"j_up", "millimolar_per_second"},
    {"j_tr", "millimolar_per_second"},
    {"delta_fTC", "per_second"},
    {"delta_fTMC", "per_second"},
    {"delta_fTMM", "per_second"},
    {"delta_fCMi", "per_second"},
    {"delta_fCMs", "per_second"},
    {"delta_fCQ", "per_second"},
    {"V_clamp", "millivolt"},
    {"E_mh", "millivolt"},
    {"fCa_infinity", "dimensionless"},
    {"tau_fCa", "second"},
    {"E_Ks", "millivolt"},
    {"E_Na", "millivolt"},
    {"E_Ca", "millivolt"},
    ...
    {"beta_m", "per_second"},
    {"tau_m", "second"},
    {"h_infinity", "dimensionless"},
    {"alpha_h", "per_second"},
    {"beta_h", "per_second"},
    {"tau_h", "second"},
    {"i_Kur", "nanoA"},
    {"r_Kur_infinity", "dimensionless"},
    {"tau_r_Kur", "second"},
    {"s_Kur_infinity", "dimensionless"},
    {"tau_s_Kur", "second"},
    {"i_siCa", "nanoA"},
    {"i_siK", "nanoA"},
    {"i_siNa", "nanoA"},
    {"i_CaL", "nanoA"},
    {"dL_infinity", "dimensionless"},
    {"adVm", "millivolt"},
    {"bdVm", "millivolt"},
    {"fL_infinity", "dimensionless"},
    {"tau_fL", "second"},
    {"i_CaT", "nanoA"},
    {"dT_infinity", "dimensionless"},
    {"tau_dT", "second"},
    {"fT_infinity", "dimensionless"},
    {"tau_fT", "second"},
    {"i_to", "nanoA"},
    ...
    {"alfapaF", "per_second"},
    {"betapaF", "per_second"},
    {"pa_infinity", "dimensionless"},
    {"tau_paS", "second"},
    {"tau_paF", "second"},
    {"tau_pi", "second"},
    {"pi_infinity", "dimensionless"},
    {"i_Ks", "nanoA"},
    {"n_infinity", "dimensionless"},
    {"alpha_n", "per_second"},
    {"beta_n", "per_second"},
    {"i_KACh", "nanoA"},
    {"beta_a", "per_second"},
    {"a_infinity", "dimensionless"},
    {"tau_a", "second"},
    {"i_NaK", "nanoA"},
    {"k41", "dimensionless"},
    {"di", "dimensionless"},
