...
const size_t STATE_VECTOR_SIZE = 33;
const size_t VARIABLE_VECTOR_SIZE = 217;

const struct VariableInfo VOI_INFORMATION = {"Nai_concentration", "time", "second"};
...
const struct VariableInfo STATE_VECTOR_INFORMATION_ARRAY[] = {
    ...
    {"Ca_SR_release", "RI", "dimensionless"},
    {"Ca_dynamics", "Ca_jsr", "millimolar"},
    {"i_CaL_fCa_gate", "fCa", "dimensionless"},
    {"Ca_buffering", "fTC", "dimensionless"},
    {"Ca_buffering", "fTMC", "dimensionless"},
    {"Ca_buffering", "fTMM", "dimensionless"},
    {"Ca_buffering", "fCMi", "dimensionless"},
    {"Ca_buffering", "fCMs", "dimensionless"},
    {"Ca_buffering", "fCQ", "dimensionless"},
    {"Ca_dynamics", "Cai", "millimolar"},
    {"Ca_dynamics", "Ca_nsr", "millimolar"},
    {"i_f_y_gate", "y", "dimensionless"},
    {"i_Na_m_gate", "m", "dimensionless"},
    {"i_Na_h_gate", "h", "dimensionless"},
    {"i_CaL_fL_gate", "fL", "dimensionless"},
    {"i_CaT_dT_gate", "dT", "dimensionless"},
    {"i_CaT_fT_gate", "fT", "dimensionless"},
    {"i_to_q_gate", "q", "dimensionless"},
    {"i_to_r_gate", "r", "dimensionless"},
    {"i_Kr_pa_gate", "paS", "dimensionless"},
    {"i_Kr_pa_gate", "paF", "dimensionless"},
    {"i_Kr_pi_gate", "piy", "dimensionless"},
    {"i_KACh_a_gate", "a", "dimensionless"},
    {"i_Kur_rKur_gate", "r_Kur", "dimensionless"},
    {"i_Kur_sKur_gate", "s_Kur", "dimensionless"},
    {"i_Ks_n_gate", "n", "dimensionless"},
...
const struct VariableInfo VARIABLE_VECTOR_INFORMATION_ARRAY[] = {
    ...
    {"Ca_SR_release", "MinSR", "dimensionless"},
    {"Ca_SR_release", "kiCa", "per_millimolar_second"},
    {"Ca_SR_release", "kim", "per_second"},
    {"Ca_SR_release", "koCa", "per_millimolar2_second"},
    {"Ca_SR_release", "kom", "per_second"},
    {"Ca_SR_release", "ks", "per_second"},
    {"Ca_buffering", "CM_tot", "millimolar"},
    {"Ca_buffering", "CQ_tot", "millimolar"},
    {"Ca_buffering", "Mgi", "millimolar"},
    {"Ca_buffering", "TC_tot", "millimolar"},
    {"Ca_buffering", "TMC_tot", "millimolar"},
    {"Ca_buffering", "kb_CM", "per_second"},
    {"Ca_buffering", "kb_CQ", "per_second"},
    {"Ca_buffering", "kb_TC", "per_second"},
    {"Ca_buffering", "kb_TMC", "per_second"},
    {"Ca_buffering", "kb_TMM", "per_second"},
    {"Ca_buffering", "kf_CM", "per_millimolar_second"},
    {"Ca_buffering", "kf_CQ", "per_millimolar_second"},
    {"Ca_buffering", "kf_TC", "per_millimolar_second"},
    {"Ca_buffering", "kf_TMC", "per_millimolar_second"},
    {"Ca_buffering", "kf_TMM", "per_millimolar_second"},
    {"Ca_intracellular_fluxes", "K_up", "millimolar"},
    {"Ca_intracellular_fluxes", "P_up_basal", "millimolar_per_second"},
    {"Ca_intracellular_fluxes", "slope_up", "millimolar"},
    {"Ca_intracellular_fluxes", "tau_dif_Ca", "second"},
    {"Ca_intracellular_fluxes", "tau_tr", "second"},
    {"Cell_parameters", "L_cell", "micrometre"},
    {"Cell_parameters", "L_sub", "micrometre"},
    {"Cell_parameters", "R_cell", "micrometre"},
    {"Cell_parameters", "V_i_part", "dimensionless"},
    {"Cell_parameters", "V_jsr_part", "dimensionless"},
    {"Cell_parameters", "V_nsr_part", "dimensionless"},
    {"Ionic_values", "Cao", "millimolar"},
    {"Ionic_values", "Ki", "millimolar"},
    {"Ionic_values", "Ko", "millimolar"},
    {"Ionic_values", "Nao", "millimolar"},
    {"Membrane", "C", "microF"},
    {"Membrane", "F", "coulomb_per_mole"},
    {"Membrane", "R", "joule_per_kilomole_kelvin"},
    {"Membrane", "T", "kelvin"},
    {"Membrane", "clamp_mode", "dimensionless"},
    {"Nai_concentration", "Nai_clamp", "dimensionless"},
    {"Rate_modulation_experiments", "ACh", "millimolar"},
    {"Rate_modulation_experiments", "Iso_1_uM", "dimensionless"},
    {"Voltage_clamp", "V_holding", "millivolt"},
    {"Voltage_clamp", "V_test", "millivolt"},
    {"Voltage_clamp", "t_holding", "second"},
    {"Voltage_clamp", "t_test", "second"},
    {"i_CaL", "P_CaL", "nanoA_per_millimolar"},
    {"i_CaL_dL_gate", "V_dL", "millivolt"},
    {"i_CaL_dL_gate", "k_dL", "millivolt"},
    {"i_CaL_fCa_gate", "Km_fCa", "millimolar"},
    {"i_CaL_fCa_gate", "alpha_fCa", "per_second"},
    {"i_CaL_fL_gate", "k_fL", "millivolt"},
    {"i_CaL_fL_gate", "shift_fL", "millivolt"},
    {"i_CaT", "P_CaT", "nanoA_per_millimolar"},
    {"i_CaT_fT_gate", "offset_fT", "second"},
    {"i_KACh", "ACh_on", "dimensionless"},
    {"i_KACh", "g_KACh", "microS"},
    {"i_Kr", "g_Kr", "microS"},
    {"i_Ks", "g_Ks_", "microS"},
    {"i_Kur", "g_Kur", "microS"},
    {"i_Na", "g_Na", "microS"},
    ...
    {"i_NaCa", "K1no", "millimolar"},
    {"i_NaCa", "K2ni", "millimolar"},
    {"i_NaCa", "K2no", "millimolar"},
    {"i_NaCa", "K3ni", "millimolar"},
    {"i_NaCa", "K3no", "millimolar"},
    {"i_NaCa", "K_NaCa", "nanoA"},
    {"i_NaCa", "Kci", "millimolar"},
    {"i_NaCa", "Kcni", "millimolar"},
    {"i_NaCa", "Kco", "millimolar"},
    {"i_NaCa", "Qci", "dimensionless"},
    {"i_NaCa", "Qco", "dimensionless"},
    {"i_NaCa", "Qn", "dimensionless"},
    {"i_NaCa", "blockade_NaCa", "dimensionless"},
    {"i_NaK", "Km_Kp", "millimolar"},
    {"i_NaK", "Km_Nap", "millimolar"},
    {"i_NaK", "i_NaK_max", "nanoA"},
    {"i_Na_m_gate", "delta_m", "millivolt"},
    {"i_f", "Km_f", "millimolar"},
    {"i_f", "alpha", "dimensionless"},
    {"i_f", "blockade", "dimensionless"},
    {"i_f", "g_f", "microS"},
    {"i_f_y_gate", "y_shift", "millivolt"},
    {"i_to", "g_to", "microS"},
    {"i_NaK", "Iso_increase", "dimensionless"},
    {"i_NaCa", "k34", "dimensionless"},
    {"Ca_intracellular_fluxes", "b_up", "dimensionless"},
    {"Ca_intracellular_fluxes", "P_up", "millimolar_per_second"},
    {"Cell_parameters", "V_cell", "millimetre3"},
    {"Nai_concentration", "V_sub", "millimetre3"},
    {"Ca_dynamics", "V_jsr", "millimetre3"},
    {"Nai_concentration", "V_i", "millimetre3"},
    {"Ca_dynamics", "V_nsr", "millimetre3"},
    {"Ionic_values", "RTONF", "millivolt"},
    {"i_f", "G_f", "microS"},
    {"i_f", "G_f_K", "microS"},
    {"i_f", "G_f_Na", "microS"},
    {"i_f", "g_f_Na", "microS"},
    {"i_f", "g_f_K", "microS"},
    {"i_f_y_gate", "ACh_shift", "millivolt"},
    {"i_f_y_gate", "Iso_shift", "millivolt"},
    {"i_CaL", "Iso_increase", "dimensionless"},
    {"i_CaL", "ACh_block", "dimensionless"},
    {"i_CaL_dL_gate", "Iso_shift_dL", "millivolt"},
    {"i_CaL_dL_gate", "Iso_slope_dL", "dimensionless"},
    {"i_Ks", "g_Ks", "microS"},
    {"i_Ks_n_gate", "Iso_shift", "millivolt"},
    {"i_KACh_a_gate", "alpha_a", "per_second"},
    {"Ionic_values", "E_K", "millivolt"},
    {"Ionic_values", "Nai", "millimolar"},
    {"i_NaCa", "k43", "dimensionless"},
    {"Ca_SR_release", "j_SRCarel", "millimolar_per_second"},
    {"Ca_SR_release", "diff", "millimolar"},
    {"Ca_SR_release", "kCaSR", "dimensionless"},
    {"Ca_SR_release", "koSRCa", "per_millimolar2_second"},
    {"Ca_SR_release", "kiSRCa", "per_millimolar_second"},
    {"Ca_SR_release", "P_tot", "dimensionless"},
    {"Ca_intracellular_fluxes", "j_Ca_dif", "millimolar_per_second"},
    {"Ca_intracellular_fluxes", "j_up", "millimolar_per_second"},
    {"Ca_intracellular_fluxes", "j_tr", "millimolar_per_second"},
    {"Ca_buffering", "delta_fTC", "per_second"},
    {"Ca_buffering", "delta_fTMC", "per_second"},
    {"Ca_buffering", "delta_fTMM", "per_second"},
    {"Ca_buffering", "delta_fCMi", "per_second"},
    {"Ca_buffering", "delta_fCMs", "per_second"},
    {"Ca_buffering", "delta_fCQ", "per_second"},
    {"Membrane", "V_clamp", "millivolt"},
    {"i_Na", "E_mh", "millivolt"},
    {"i_CaL_fCa_gate", "fCa_infinity", "dimensionless"},
    {"i_CaL_fCa_gate", "tau_fCa", "second"},
    {"i_Ks", "E_Ks", "millivolt"},
    {"Ionic_values", "E_Na", "millivolt"},
    {"Ionic_values", "E_Ca", "millivolt"},
    {"i_NaK", "V", "millivolt"},
    {"Nai_concentration", "i_fNa", "nanoA"},
    {"i_f", "i_fK", "nanoA"},
    {"Membrane", "i_f", "nanoA"},
    {"i_f_y_gate", "tau_y", "second"},
    {"i_f_y_gate", "y_infinity", "dimensionless"},
    {"i_Na", "i_Na_", "nanoA"},
    {"i_Na", "i_Na_L", "nanoA"},
    {"Nai_concentration", "i_Na", "nanoA"},
    {"i_Na_m_gate", "m_infinity", "dimensionless"},
    {"i_Na_m_gate", "E0_m", "millivolt"},
    {"i_Na_m_gate", "alpha_m", "per_second"},
    {"i_Na_m_gate", "beta_m", "per_second"},
    {"i_Na_m_gate", "tau_m", "second"},
    {"i_Na_h_gate", "h_infinity", "dimensionless"},
    {"i_Na_h_gate", "alpha_h", "per_second"},
    {"i_Na_h_gate", "beta_h", "per_second"},
    {"i_Na_h_gate", "tau_h", "second"},
    {"Membrane", "i_Kur", "nanoA"},
    {"i_Kur_rKur_gate", "r_Kur_infinity", "dimensionless"},
    {"i_Kur_rKur_gate", "tau_r_Kur", "second"},
    {"i_Kur_sKur_gate", "s_Kur_infinity", "dimensionless"},
    {"i_Kur_sKur_gate", "tau_s_Kur", "second"},
    {"Ca_dynamics", "i_siCa", "nanoA"},
    {"i_CaL", "i_siK", "nanoA"},
    {"Nai_concentration", "i_siNa", "nanoA"},
    {"Membrane", "i_CaL", "nanoA"},
    {"i_CaL_dL_gate", "dL_infinity", "dimensionless"},
    {"i_CaL_dL_gate", "adVm", "millivolt"},
    {"i_CaL_dL_gate", "bdVm", "millivolt"},
    {"i_CaL_fL_gate", "fL_infinity", "dimensionless"},
    {"i_CaL_fL_gate", "tau_fL", "second"},
    {"Ca_dynamics", "i_CaT", "nanoA"},
    {"i_CaT_dT_gate", "dT_infinity", "dimensionless"},
    {"i_CaT_dT_gate", "tau_dT", "second"},
    {"i_CaT_fT_gate", "fT_infinity", "dimensionless"},
    {"i_CaT_fT_gate", "tau_fT", "second"},
    {"Membrane", "i_to", "nanoA"},
    {"i_to_q_gate", "q_infinity", "dimensionless"},
    {"i_to_q_gate", "tau_q", "second"},
    {"i_to_r_gate", "r_infinity", "dimensionless"},
    {"i_to_r_gate", "tau_r", "second"},
    {"Membrane", "i_Kr", "nanoA"},
    {"i_Kr_pa_gate", "alfapaF", "per_second"},
    {"i_Kr_pa_gate", "betapaF", "per_second"},
    {"i_Kr_pa_gate", "pa_infinity", "dimensionless"},
    {"i_Kr_pa_gate", "tau_paS", "second"},
    {"i_Kr_pa_gate", "tau_paF", "second"},
    {"i_Kr_pi_gate", "tau_pi", "second"},
    {"i_Kr_pi_gate", "pi_infinity", "dimensionless"},
    {"Membrane", "i_Ks", "nanoA"},
    {"i_Ks_n_gate", "n_infinity", "dimensionless"},
    {"i_Ks_n_gate", "alpha_n", "per_second"},
    {"i_Ks_n_gate", "beta_n", "per_second"},
    {"Membrane", "i_KACh", "nanoA"},
    {"i_KACh_a_gate", "beta_a", "per_second"},
    {"i_KACh_a_gate", "a_infinity", "dimensionless"},
    {"i_KACh_a_gate", "tau_a", "second"},
    {"Nai_concentration", "i_NaK", "nanoA"},
    {"i_NaCa", "k41", "dimensionless"},
    {"i_NaCa", "di", "dimensionless"},
    {"i_NaCa", "k32", "dimensionless"},
    {"i_NaCa", "do", "dimensionless"},
    {"i_CaL_dL_gate", "alpha_dL", "per_second"},
    {"i_CaL_dL_gate", "beta_dL", "per_second"},
    {"i_Ks_n_gate", "tau_n", "second"},
    {"i_NaCa", "k12", "dimensionless"},
    {"i_NaCa", "k14", "dimensionless"},
    {"i_NaCa", "k21", "dimensionless"},
    {"i_NaCa", "k23", "dimensionless"},
    {"i_CaL_dL_gate", "tau_dL", "second"},
    {"i_NaCa", "x1", "dimensionless"},
    {"i_NaCa", "x2", "dimensionless"},
